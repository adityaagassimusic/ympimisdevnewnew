...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li>
            <a data-toggle="modal" data-target="#uploadModal" class="btn btn-success btn-md" style="color:white"><i class="fa fa-upload"></i>Upload Forecast</a>
        </li>
    </ol>
</section>
@endsection
        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom" style="margin-top: 1%;">
                <ul class="nav nav-tabs" style="font-weight: bold; font-size: 15px">
                    <li class="vendor-tab active"><a href="#tab_1" data-toggle="tab" id="tab_header_1">Forecast</a></li>
                </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Upload Forcast</h4>
                Format : [<b><i>Month</i></b>][<b><i>Material Number</i></b>][<b><i>Quantity</i></b>]
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-10 col-xs-offset-1">
                        <div class="col-xs-12">
                            <label>Forecast Period :<span class="text-red">*</span></label>
                        </div>
                        <div class="col-xs-6" style="padding-right: 0px;">
                            <input type="text" class="form-control" name="period" id="period" placeholder="Enter Forecast Period (Ex : 2108)">  
                        </div>
                        ...
                        <div class="col-xs-6" style="padding-right: 0px;">
                            <div class="input-group date pull-right" style="text-align: center;">
                                ...
                                <input type="text" class="form-control monthpicker" name="start" id="start" placeholder="Start Month">  
                            </div>
                        </div>
                        <div class="col-xs-6" style="padding-left: 5px;">
                            <div class="input-group date pull-right" style="text-align: center;">
                                ...
                                <input type="text" class="form-control monthpicker" name="end" id="end" placeholder="End Month">  
                            </div>
                        </div>
                        <div class="col-xs-12" style="margin-top: 2%;">
                            <label>Forcast Data :<span class="text-red">*</span></label>
                        </div>
                        <div class="col-xs-12">
            ...
            <div class="modal-footer">
                <div class="row" style="margin-top: 7%; margin-right: 2%;">
                    ...
                    <button onclick="uploadForecast()" class="btn btn-success">Upload </button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function uploadForecast() {
        ...
        $('#loading').show();
        $.post('{{ url("upload/production_forecast") }}', data, function(result, status, xhr){
            if(result.status){
                ...
                $('#loading').hide();
                openSuccessGritter('Success', 'Upload Forecast Success');
    ...
    function fetchTable() {
        ...
        $('#loading').show();
        $.get('{{ url("fetch/production_forecast") }}', data,  function(result, status, xhr){
            if(result.status){
                ...
                for (var i = 0; i < result.material.length; i++) {
                    ...
                    for (var j = 0; j < result.interval.length; j++) {
                        ...
                        for (var k = 0; k < result.forecast.length; k++) {
                            if((result.forecast[k].material_number == result.material[i].material_number) && (result.forecast[k].month == result.interval[j].month)){
                                bodyQty += '<td style="vertical-align: middle; text-align: center;">'+result.forecast[k].quantity+'</td>';
                                inserted = true;
                            }
                        }
