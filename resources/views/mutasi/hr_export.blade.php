		...
		<div class="col-xs-12">
			<div class="box no-border" style="margin-bottom: 5px;">
				...
				<div class="row">
					...
					<form method="GET" action="{{ url("excel/mutasi/hr") }}">
						<div class="col-xs-12">
							<!-- <div class="col-md-2">
  ...
  <div class="col-xs-12" style="padding-top: 1%;">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs" style="font-weight: bold; font-size: 15px">
        <li class="vendor-tab active"><a href="#tab_1" data-toggle="tab" id="tab_header_1">Satu Departemen</a></li>
