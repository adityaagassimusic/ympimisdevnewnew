...
<section class="content">
  ...
  <!-- SELECT2 EXAMPLE -->
  @if(
      (($user == $resumes[0]->chief_or_foreman_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ca == null && $resumes[0]->posisi == "chf_asal") 
      || (($user == $resumes[0]->manager_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ma == null && $resumes[0]->posisi == "mgr_asal")
      || (($user == $resumes[0]->dgm_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_da == null && $resumes[0]->posisi == "dgm_asal")
      || (($user == $resumes[0]->gm_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ga == null && $resumes[0]->posisi == "gm_asal")
      || (($user == $resumes[0]->chief_or_foreman_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ct == null && $resumes[0]->posisi == "chf_tujuan") 
      || (($user == $resumes[0]->manager_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_mt == null && $resumes[0]->posisi == "mgr_tujuan")
      || (($user == $resumes[0]->dgm_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_dt == null && $resumes[0]->posisi == "dgm_tujuan")
      || (($user == $resumes[0]->gm_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_gt == null && $resumes[0]->posisi == "gm_tujuan")
      || (($user == $resumes[0]->manager_hrga || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_m == null && $resumes[0]->posisi == "mgr_hrga")
      || (($user == $resumes[0]->direktur_hr || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_dir == null && $resumes[0]->posisi == "dir_hr")
      )
    ...
    <div class="box-body"> 
        <table class="table table-bordered">
          <tr id="show-att">
            ...
            <thead>
              ...
              <tr>
                <td colspan="13" style="text-align: center;font-weight: bold;font-size: 20px">(Antar Departemen)</td>
              </tr>
              <tr>
                <td colspan=5><br></td>
              </tr> 
        ...
        <tr align="center">
          ...
          <td colspan="5" style="font-size: 12px; border: 1px solid black">{{ $resumes[0]->departemen }}</td>
          <td colspan="5" style="font-size: 12px; border: 1px solid black">{{ $resumes[0]->ke_departemen }}</td>
        </tr>
        <tr align="center">
    ...
    <br>
        <table style="width: 100%; font-family: arial; border-collapse: collapse; ">
            <tr style="background-color: rgb(126,86,134);">
                <th colspan="1" style="font-size: 9px; width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">11</th>
                ...
                <tr style="background-color: rgb(126,86,134);">
                <th style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Menyetujui</th>
                <th style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Mengetahui</th>
                <th colspan="4" style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Disetujui Div. Penerima</th>
                <th colspan="4" style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Disetuji Div. Pengusul</th>
            </tr>
            <tr style="background-color: rgb(126,86,134);">
                <th colspan="1" style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Direktur HR</th>
                <!-- <th colspan="1" style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Presiden Direktur</th> -->
                <th colspan="1" style="width:8%; background-color: yellow; font-weight: bold; border: 1px solid black; text-align: center;">Manager HR</th>
            ...
            <tr>
                ...
                <!-- @if(($resumes[0]->jabatan != 'Operator') && ($resumes[0]->jabatan != 'Operator Contract') && ($resumes[0]->app_gt == 'Approved'))
                <td style="height: 40px; width: 6%; border:1px solid black; text-align: center; font-weight: bold">Hiromichi Ichimura</td>
                @else
                <td style="height: 40px; width: 6%; border:1px solid black; text-align: center; font-weight: bold"></td>
                @endif -->
                ...
                <td style="height: 40px; width: 6%; border:1px solid black; text-align: center; font-weight: bold">{{ $resumes[0]->nama_gm_asal }}</td>
                <td style="height: 40px; width: 6%; border:1px solid black; text-align: center; font-weight: bold">{{ $resumes[0]->nama_dgm_asal }}</td>
                <td style="height: 40px; width: 6%; border:1px solid black; text-align: center; font-weight: bold">{{ $resumes[0]->nama_manager_asal }}</td>
            ...
            <tr>
                ...
                <!-- <td style="width: 6%; border:1px solid black; text-align: center;"></td> -->
                <td style="width: 6%; border:1px solid black; text-align: center;"></td>
              ...
              <div class="col-md-12">
                <div class="panel panel-default">
                  ...
                  <div class="panel-body center-text"  style="padding: 20px">
                    @if(($user == $resumes[0]->chief_or_foreman_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ca == null && $resumes[0]->posisi == "chf_asal")
                    <a href="{{url('approvechief_or_foremanasalAntar/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->manager_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ma == null && $resumes[0]->posisi == "mgr_asal")
                    <a href="{{url('approve_manager_asal/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->dgm_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_da == null && $resumes[0]->posisi == "dgm_asal")
                    <a href="{{url('approve_dgm_asal/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->gm_asal || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ga == null && $resumes[0]->posisi == "gm_asal")
                    <a href="{{url('approve_gm_asal/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->chief_or_foreman_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_ct == null && $resumes[0]->posisi == "chf_tujuan")
                    <a href="{{url('approvechief_or_foremantujuan/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->manager_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_mt == null && $resumes[0]->posisi == "mgr_tujuan")
                    <a href="{{url('approve_manager_tujuan/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->dgm_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_dt == null && $resumes[0]->posisi == "dgm_tujuan")
                    <a href="{{url('approve_dgm_tujuan/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->gm_tujuan || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_gt == null && $resumes[0]->posisi == "gm_tujuan")
                    <a href="{{url('approve_gm_tujuan/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->manager_hrga || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_m == null && $resumes[0]->posisi == "mgr_hrga")
                    <a href="{{url('approvemanager_hrga/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @elseif(($user == $resumes[0]->direktur_hr || Auth::user()->role_code == "S-MIS") && $resumes[0]->app_dir == null && $resumes[0]->posisi == "dir_hr")
                    <a href="{{url('approvedirektur_hr/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-success col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Verifikasi (承認する)</button></a>
                    @else
                    <button class="btn btn-danger col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px"><a href="" style="color: white" onclick="loading()">Verifikasi (承認する)</a></button>
                    @endif
                    <br>
                    <br>
                    <a href="{{url('rejectedantar_departemen/'.$resumes[0]->id)}}" style="color: white"><button class="btn btn-danger col-sm-12" style="width: 100%; font-weight: bold; font-size: 20px" onclick="loading()">Rejected (却下する)</button></a>
                  </div>
                </div>
              </div>
            </td>
