...
<script>
  ...
  function search() {
    ...
    var data = {
      ...
      subject_sakurentsu : $("#subject_sakurentsu").val(),
      department : $("#department").val()
    };


    $.get('{{ url("fetch/sakurentsu/summary/information") }}', data, function(result, status, xhr){
      if (result.status) {
        $("#loading").hide();
