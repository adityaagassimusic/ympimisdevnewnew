	...
	<div>
		<center>
			...
			<p style="font-size: 18px; font-weight: bold">
				...
				<?php } else if ($data["position"] == "DEPT APPROVAL" || $data["position"] == "PIC APPROVAL") { ?>
			...
			<table style="width: 80%; text-align: center; border: 0px" id="ttd_table">
				...
				<td style="border: 0px">
					...
					<a style="background-color: #fa932d;color: white;font-size:20px;" href="{{ url('detail/sakurentsu/3m/'.$id.'/finish') }}">&nbsp;&nbsp;&nbsp; 3M Detail &nbsp;&nbsp;&nbsp;</a>
				</td>
			...
			<td style="border: 0px">
				...
				<a style="background-color: #fa932d; width: 50px;text-decoration: none;color: white;font-size:20px;" href="{{ url('detail/sakurentsu/3m/'.$id.'/view') }}">&nbsp;&nbsp;&nbsp; 3M Detail (3M変更の詳細) &nbsp;&nbsp;&nbsp;</a>
			</td>
