    ...
    <header class="main-header" >
     ...
     <div class="content-wrapper" style="background-color: #ecf0f5; padding-top: 10px;">
      <section class="content">
        ...
        <?php if ($remark == 'Manager'): ?>
          <div class="box box-solid" id="div_reason">
            <div class="box-body">
              <div class="form-group row" align="right">
                <label class="col-sm-2">Reason<span class="text-red">*</span></label>
                <div class="col-sm-5" align="left">
                  <input class="form-control" id="reason" placeholder="Masukkan Reason" style="width: 100%">
                </div>
                <div class="col-sm-3">
...
<script type="text/javascript">
  ...
  function confirmReason() {
    ...
    $.get('{{ url("reason/human_resource/leave_request") }}',data, function(result, status, xhr){
      if(result.status){
        $('#div_reason').hide();
