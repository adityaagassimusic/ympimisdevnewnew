...
<body>
  <div>
    <center>
      ...
      <span style="font-weight: bold; color: purple; font-size: 24px;">PERMOHONAN UANG SIMPATI</span><br>
    ...
    <center>
      <div style="width: 80%">
        ...
        <table style="border:1px solid black; border-collapse: collapse; width: 60%;">
          <tbody align="center">
            <tr>
              <td colspan="2" style="border:1px solid black; font-size: 15px; width: 20%; height: 20; font-weight: bold; background-color: rgb(126,86,134);color: white;text-align: center;">{{ $permohonan[0] }}</td>
            </tr>
          </tbody>
        </table>
        <br>
