...
<body>
  <div>
    <center>
      ...
      <?php
      $permohonan = explode("/", $data['data'][0]->permohonan);
      ?>
      <span style="font-weight: bold; color: purple; font-size: 24px;">Permohonan {{ $permohonan[0] }}</span><br>
    </center>
  </div>      
  <div>
    <center>
      <div style="width: 80%">
        ...
        <table style="width: 100%">
          ...
          @if($data['approver']->remark == 'Menyetujui, HR')
          <tr>
            <th style="width: 10%; font-weight: bold; color: black;">
              <a style="background-color: #f3bc00; width: 50px;text-decoration: none;color: white;font-size: 20px;"  href="{{ url('human_resource') }}">&nbsp; See For All Approvals &nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </th>
          </tr>
          @endif
        </table>
