			...
			<div class="content-wrapper" style="background-color: #ecf0f5; padding-top: 10px;">
				<section class="content">
					...
					<div class="error" style="text-align: center;">
						<h1><i class="fa fa-file-text-o"></i> Request ID (承認番号)  {{ $data->request_id }}</h1>
						<p>
							@if($p == 'Request Berhasil Disetujui')
							<h2 class="text-green">
								<i class="fa fa-check-circle fa-lg"></i> {{$p}}<br>
							</h2>
							@elseif($p == 'Request Ini Telah Disetujui')
							<h2 class="text-green">
								<i class="fa fa-thumbs-up"></i> {{$p}}<br>
							</h2>
							@elseif($p == 'Terimakasih Anda Telah Melakukan Persetujuan, Sekarang Saatnya Approval Berikutnya.')
							<h2 class="text-green">
								<i class="fa fa-thumbs-up"></i> {{$p}}<br>
							</h2>
							@else
							<h2 class="text-red">
								<i class="fa fa-times"></i> {{$p}}<br>
							</h2>
							@endif
						</p>
					</div>
