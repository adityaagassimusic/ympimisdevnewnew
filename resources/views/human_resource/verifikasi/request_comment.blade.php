    ...
    <header class="main-header" >
     ...
     <div class="content-wrapper" style="background-color: #ecf0f5; padding-top: 0px;">
      <section class="content">
        @if($data->posisi != "user")
        <form role="form" method="post" id="formNote" action="{{url('human_resource/comment/'.$data->request_id)}}">
          <div class="col-xs-12 " style="text-align: center;" id="show">
            <h1>Request Man Power</h1>
            <h1><i class="fa fa-file-text-o"></i> {{ $data->request_id }}</h1>
            <p>
              ...
              <div class="col-xs-12">
                ...
                <input type="hidden" class="form-control" id="posisi" name="posisi" value="{{ $data->posisi }}" required=""></textarea>
              </div>
        ...
        @else
          ...
          <div class="col-xs-12" style="text-align: center;" id="show">
            ...
            <p>
              ...
              <div class="col-xs-12">
                <h2>Question : <br><br><?= $data->comment_note ?></h2>
              </div>
