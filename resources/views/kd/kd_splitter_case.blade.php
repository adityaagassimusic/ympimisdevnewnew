...
<section class="content-header">
    <h1>
        ...
        <small>Splitter KD Case <span class="text-purple"> KDケーススプリッター</span></small>
    </h1>
</section>
@endsection
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <center><span style="font-size: 3vw; color: red;font-weight: bold;"><i class="fa fa-angle-double-down"></i> SCAN KDO CASE <i class="fa fa-angle-double-down"></i></span></center>
                </div>
