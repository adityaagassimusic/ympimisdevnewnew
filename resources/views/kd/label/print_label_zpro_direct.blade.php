...
<body >
	...
	<table border="0" style="margin: 0px;">
		<input type="text" name="material_number" id="material_number" value="{{$material_number}}" hidden="">
		<input type="text" name="material_description" id="material_description" value="{{$material_description}}" hidden="">
