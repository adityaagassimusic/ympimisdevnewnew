...
<body>
    ...
    <div style="display: inline-block;">
        <table style="position: fixed; left: 10px; top: 9px;">
            <tr height="22px">
                <th colspan="2" style="width: 90px;" class="top" id="kd_name"></th>
                <th colspan="2" style="width: 90px;" class="top" id="quantity"></th>
                <th colspan="2" style="width: 90px;" class="top" id="xy_name"></th>
            </tr>
            <tr height="35px">
                <th colspan="6" style="width: 270px;" class="desc" id="material_description">
                </th>
            </tr>
            <tr height="35px">
                <th colspan="3">
...
<script>
    ...
    function initialize() {
        ...
        var url2 = "/barcode.php?f=svg&s=code-128&w=80&h=30&p=0&wq=0";
        ...
        var material_number2 = "/barcode.php?f=svg&s=code-128&w=80&h=30&p=0&wq=0";
