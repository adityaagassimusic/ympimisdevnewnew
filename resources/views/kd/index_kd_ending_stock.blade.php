...
<script>
	...
	function reprintKDODetail(id){
		...
		printLabel(kd_detail, ('reprint'+kd_detail));
		openSuccessGritter('Success!', "Reprint Success");

	}

	function printLabel(kd_detail,windowName) {
		var location = "{{ $location }}";
		
		var url = '';
		if(location == 'cl-body'){
			url = '{{ url("index/print_label_cl_body") }}'+'/'+kd_detail;
		}else if(location == 'b-pro'){
		...
		}else if(location == 'rc-assy'){
			url = '{{ url("index/print_label_rc_assy") }}'+'/'+kd_detail;
		}
	...
	function print() {
		...
		if(location == 'cl-body'){
			url = '{{ url("fetch/kd_print_cl_body") }}';
		}else if(location == 'b-pro'){
			...
			url = '{{ url("fetch/kd_print_vn_injection_single") }}';
		}else if(location == 'vn-assy'){
			url = '{{ url("fetch/kd_print_vn_assy_single") }}';
		}else if(location == 'rc-assy'){
			url = '{{ url("fetch/kd_print_rc_assy") }}';
		}
