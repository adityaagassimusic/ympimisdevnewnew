...
<section class="content-header">
	<h1>
		History Check Request MOD<span class="text-purple">??</span>
						...
						<div class="col-md-4 col-md-offset-2">
							...
							<div class="form-group">
								<div class="input-group date">
									...
									<input type="text" class="form-control " id="gmc" name="gmc" autocomplete="off">
								</div>
							</div>
						</div>
...
<script>
	...
	function initiateTable() {
		...
		tableData += '<th>Kode Requet</th>';
		tableData += '<th>GMC</th>';
		tableData += '<th>Quantity Total</th>';
		tableData += '<th>GMC</th>';
	...
	function fillList(){
		...
		$.get('{{ url("fetch/history/check") }}',data, function(result, status, xhr){
			if(result.status){
				initiateTable();
				fetchHistory();
				var tableData = "";
