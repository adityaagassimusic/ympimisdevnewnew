            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Repair Logs Filters</h3>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        function cancelRepair(id) {
            ...
            if (confirm(
                    "Repair akan di batalkan. Apakah anda yakin melanjutkan proses ini ?\nData yang telah disimpan tidak dapat dikembalikan."
                    )) {
                $.post('{{ url('cancel/repair') }}', data, function(result, status, xhr) {
                    if (result.status) {
