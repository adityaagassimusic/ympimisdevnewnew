			...
			<div class="row" style="margin:0px;">
				<div class="box box-primary">
					<div class="box-body">
						...
						<table style="border:1px solid black; border-collapse: collapse; width: 70%; padding-top: 0px" align="center">
							<tr>
								<td style="width: 40%; font-size: 15px; font-weight: bold; border: 1px solid black; padding-left: 20px">Alasan Reject</td>
...
<script>
	...
	jQuery(document).ready(function() {
		...
		function SaveAlasan(){
			...
			$.post('{{ url("adagio/post/reject") }}', data, function(result, status, xhr) {
				if(result.status){
					$('#loading').hide();
					openSuccessGritter('Success','Alasan Reject Terkirim Ke Pembuat!');
