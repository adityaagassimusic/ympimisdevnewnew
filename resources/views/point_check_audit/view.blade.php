      ...
      <div class="box-body">
        ...
        <div class="form-group row" align="right">
          ...
          <div class="col-sm-5" align="left">
            {{$pointCheckAudit->product}}
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Proses</label>
          <div class="col-sm-5" align="left">
            {{$pointCheckAudit->proses}}
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Point Pengecekan</label>
          <div class="col-sm-5" align="left">
            <?php echo $pointCheckAudit->point_check ?>
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Cara Cek</label>
          <div class="col-sm-5" align="left">
          <?php echo $pointCheckAudit->cara_cek ?>
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Created By</label>
          <div class="col-sm-5" align="left">
            {{$pointCheckAudit->user->name}}
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Created At</label>
          <div class="col-sm-5" align="left">
            {{$pointCheckAudit->created_at}}
          </div>
        </div>
        <div class="form-group row" align="right">
          <label class="col-sm-5">Last Update</label>
          <div class="col-sm-5" align="left">
            {{$pointCheckAudit->updated_at}}
          </div>
        </div>
        <a class="btn btn-info" href="{{ url('index/point_check_audit/index/'.$id) }}">Cancel</a>
    </div>
