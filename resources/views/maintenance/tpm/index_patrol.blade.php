	...
	<div class="row">
		<div class="col-xs-12">
			<div class="col-xs-12" style="text-align: center;margin-top:-30px;padding: 0">
				<h3 class="box-title" style="color: white;margin-top: 10px;font-size: 28px;font-weight: bold;background-color: #2196f3;padding: 10px">Patrol Kondisi Bangunan<span class="text-purple"></span></h3>
			</div>
				...
				<div class="box box-solid">
					...
					<table class="table table-responsive" style="border: 0;background:#2a2a2b">
						<tr>
							...
							<th style="vertical-align: top;font-weight: bold;font-size: 1.1vw;border-top: 1px solid #111"><input type="text" id="tgl_audit" class="datepicker" placeholder="Tanggal Patrol" style="width: 100%">
							</th>
						</tr>
						<tr>
						...
						<tr class="member">
							...
							<td width="10%">
								...
								<select class="form-control select3 patrol_detail" id="patrol_detail" data-placeholder="Patrol Category" style="width: 100%; font-size: 20px;">
									<option></option>
									<option value="Lantai tidak rusak/lubang">Lantai tidak rusak/lubang</option>
									<option value="Dinding tidak rusak/lubang">Dinding tidak rusak/lubang</option>
									<option value="Atap tidak rusak/lubang">Atap tidak rusak/lubang</option>
									<option value="Atap tidak bocor">Atap tidak bocor</option>
									<option value="Partisi/Ruangan tidak rusak">Partisi/Ruangan tidak rusak</option>
									<option value="Pintu auto/manual tidak rusak">Pintu auto/manual tidak rusak</option>
								</select>
							</td>
							<td width="10%">
								<center>
							...
							<td width="10%">
								<select class="form-control select2 patrol_pic" id="patrol_pic" data-placeholder="Pilih PIC" style="width: 100%; font-size: 20px;">
									...
									<option value="{{ $audite->name }}">{{ $audite->name }}</option>
									@endforeach
								</select>
	...
	<script>
		...
		function cek() {
			// if (confirm('Apakah Anda yakin?')) {
				...
				formData.append('date', $('#tgl_audit').val());
