        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom" style="margin-top: 1%;">
                <ul class="nav nav-tabs" style="font-weight: bold; font-size: 15px">
                    <li class="vendor-tab active"><a href="#tab_1" data-toggle="tab" id="tab_header_1">Forecast Usage</a></li>
                </ul>
...
<script>
    ...
    function fetchTable() {
        ...
        $('#loading').show();
        $.get('{{ url("fetch/material/forecast_usage") }}',  function(result, status, xhr){
            if(result.status){
