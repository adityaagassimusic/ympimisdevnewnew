				...
				<div class="box-body">
					<div class="col-xs-2">
						<div class="form-group">
							...
							<div class="input-group" style="width: 100%;">
								<input type="text" placeholder="Form Number" class="form-control pull-right" name="s_form_number" id="s_form_number">
							</div>
						</div>
					</div>
					...
					<div class="col-xs-2">
						<div class="form-group">
							...
							<div class="input-group" style="width: 100%;">
								<input type="text" placeholder="Investment Number" class="form-control pull-right" name="s_investment_number" id="s_investment_number">
							</div>
						</div>
					</div>
					...
					<div class="col-xs-2">
						<div class="form-group">
							...
							<div class="input-group" style="width: 100%;">
								<input type="text" placeholder="Invoice Number" class="form-control pull-right" name="s_invoice_number" id="s_invoice_number">
							</div>
						</div>
					</div>
					...
					<div class="col-xs-3">
						<div class="form-group">
							<label>Investment Applicant</label>
							<div class="input-group" style="width: 100%;">
								<input type="text" placeholder="Investment Applicant" class="form-control pull-right" name="s_investment_app" id="s_investment_app">
							</div>
						</div>
					</div>
	...
	<div class="col-md-12" style="padding-top: 10px;">
						...
						<thead style="background-color: rgba(126,86,134,.7);">
							<tr>
								...
								<!-- <th style="width: 10%">Invoice Number</th>
									<th style="width: 10%">Invoice Name</th> -->
									<!-- <th style="width: 10%">Fixed Asset Name</th> -->
									<th style="width: 10%">Categories</th>
									<th style="width: 9%">Investment Applicant</th>
									<th style="width: 3%">Created At</th>
									<th style="width: 3%">Status</th>
									<th style="width: 8%">Invoice Document</th>
								</tr>
							</thead>
		...
		<script>
			...
			function getInvestmentList() {
				investment_list =  <?php echo json_encode($investment); ?>

				$("#investment_number").empty();
				var option = "";
				var option = "<option value=''></option>";
				$.each(investment_list, function(index, value){
					option += "<option>"+value.reff_number+"</option>";
				})

				$("#investment_number").append(option);
			}
