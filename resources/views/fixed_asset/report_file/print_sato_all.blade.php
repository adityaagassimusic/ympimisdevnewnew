...
<body >
	...
	foreach ($data_asset as $dt_set) {

		QRcode::png($dt_set->fixed_asset_id, public_path().'/fa-qr.png');
		...
		<table style="width: 330px; margin-left: 20px;">
			...
			<tr>
				<th colspan="3" style="padding-top: 0px; padding-bottom: 0px; vertical-align: top;" width="100px" class="desc" id="fixed_asset_name">{{ $dt_set->fixed_asset_name }}</th>
			</tr>
			<tr>
				<th style="width: 20%; font-size: 11pt">{{ $dt_set->fixed_asset_id }}</th>
				<th style="padding-top: 0px; padding-bottom: 0px;; font-size: 11pt" width="100px">&nbsp;</th>
				<th style="width: 20%; font-size: 11pt">{{ $dt_set->req_date }}</th>
			</tr>
			<tr>
