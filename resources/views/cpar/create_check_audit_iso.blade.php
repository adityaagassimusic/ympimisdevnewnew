	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a  class="btn btn-danger" href="{{ url('index/audit_iso/create_audit') }}">Tutup</a>
			...
			for(var i = 0; i < countpoint; i++){
				...
				$.ajax({
					...
					if (stat == countpoint) {
						...
						$('.modal-body').html("Terima Kasih telah mengisi Audit Internal ISO.<br>Data sudah berhasil disimpan ke database sistem.");
