...
<section class="content-header">
	<h1>
		Audit Bulanan Produk Pertama - {{ $leader }}
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" align="center"><b>Buat Audit Bulanan Produk Pertama</b></h4>
      </div>
      <div class="modal-body">
      	<div class="box-body">
...
<script>
    ...
    function printPdf(id,first_product_audit_id,month) {
    	if (month == "") {
			...
			var url = "{{url('index/first_product_audit/print_first_product_audit/')}}";
