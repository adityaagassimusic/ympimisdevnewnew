	...
	<div class="row">
		<div class="col-xs-12">
			<div class="col-xs-12" style="text-align: center;margin-top:-30px;padding: 0">
				<h3 class="box-title" style="color: white;margin-top: 10px;font-size: 28px;font-weight: bold;background-color: #2196f3;padding: 10px">Patrol Penghematan Energi Shift 1 & 2<span class="text-purple"></span></h3>
			</div>
