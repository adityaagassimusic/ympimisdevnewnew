...
<head>
	...
	<style type="text/css">
		...
		@page { margin: 60px 20px 10px 20px; }
	...
	for ($i=1; $i <= count($lists); $i++) { 
		...
		<div class='mstr'>
			<table style="width: 95%;  margin-left: auto; margin-right: auto; margin-bottom: 10px">
				...
				<tr>
					<th style="background-color: black; text-align: center; color:white">IN SOLUTION</th>
				...
				<tr>
					<td style="text-align: center; height: 20px">STRIKE Au</td>
					<td style="text-align: center; height: 20px">[ ___________ ]</td>
					<td style="text-align: center; height: 20px">X1</td>
					<td style="text-align: center; height: 20px">[ ___________ ]</td>
				</tr>
				<tr>
					<td style="text-align: center; height: 20px">GLOSSY Au</td>
					<td style="text-align: center; height: 20px">[ ___________ ]</td>
					<td style="text-align: center; height: 20px">X1</td>
					<td style="text-align: center; height: 20px">[ ___________ ]</td>
				</tr>
