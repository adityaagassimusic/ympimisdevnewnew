      ...
      <div style="width: 100%">
        <table style="width: 100%; font-family: TimesNewRoman; border-collapse: collapse; text-align: left;" >
          <thead>
            ...
            <tr>
              <td colspan="9" style="text-align: left;font-size: 11px">Jl. Rembang Industri I/36 Kawasan Industri PIER - Pasuruan</td>
              <td style="font-size: 13px; text-align: right">No Request : {{ $data[0]->request_id}}</td>
            </tr>
            <tr>
              <td colspan="9" style="text-align: left;font-size: 11px">Phone : (0343) 740290 Fax : (0343) 740291</td>
        ...
        <table class="table table-bordered table-hover" style="width: 100%; margin-bottom: 0px; text-align: center">
          <thead style="background-color: #605ca8; color: white;">
            <tr>
              <th colspan="2">Kejadian berdasarkan pengalaman selama bekerja, yang hampir menimbulkan
          ...
          <tbody style="background-color: #fcf8e3;">
            <tr>
              <td style="text-align: center; width: 100%" colspan="2">Nama Tim : {{ $data[0]->nama_tim }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Pelapor</td>
              <td style="text-align: center; width: 50%">{{ $karyawan[0] }} - {{ $karyawan[1] }}<br>{{ $karyawan[3] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Saksi</td>
              <td style="text-align: center; width: 50%">{{ $saksi[0] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Tanggal Kejadian</td>
              <td style="text-align: center; width: 50%">{{ $data[0]->tanggal }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Lokasi Kejadian</td>
              <td style="text-align: center; width: 50%">{{ $data[0]->lokasi }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Ringkasan Kejadian</td>
              <td style="text-align: center; width: 50%">{{ $kejadian[0] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Alat Pelindung Diri yang digunakan (jika ada)</td>
              <td style="text-align: center; width: 50%">{{ $kejadian[1] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Keparahan</td>
              <td style="text-align: center; width: 50%">{{ $detail[0] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%">Kemungkinan</td>
              <td style="text-align: center; width: 50%">{{ $detail[1] }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%"> Tindakan Perbaikan - Tindakan yang dilakukan atau sudah dilakukan untuk mencegah kejadian tersebut tidak terulang lagi</td>
              <td style="text-align: center; width: 50%">{{ $data[0]->perbaikan }}</td>
            </tr>
            <tr>
              <td style="text-align: left; width: 50%"> Informasi Lain</td>
              <td style="text-align: center; width: 50%">{{ $data[0]->lain_lain}}</td>
            </tr>
            @if($data[0]->penanganan != null)
            <tr>
              <td style="text-align: left; width: 50%"> Penanganan</td>
              <td style="text-align: center; width: 50%; background-color: yellow">{{ $data[0]->penanganan }}</td>
            </tr>
            @endif
          </tbody>
        </table>
