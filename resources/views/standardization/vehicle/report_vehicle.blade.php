...
<script>
	...
	function initiateTable() {
		...
		tableData += '<th width="1%">Tanggal Inspeksi</th>';
		tableData += '<th width="1%">Nomor Polisi</th>';
		tableData += '<th width="3%">Nama</th>';
		tableData += '<th width="1%">Dept</th>';
		tableData += '<th width="2%">Catatan</th>';
		tableData += '<th width="3%">Foto</th>';
		tableData += '</tr>';
		tableData += '</thead>';
	...
	function fillList(){
			...
			$.get('{{ url("fetch/standardization/vehicle_report") }}', function(result, status, xhr){
			if(result.status){
				...
				$.each(result.vehicle, function(key, value) {
					...
					if (value.inspection_date == null) {
						...
						tableData += '<td>'+ (getFormattedDate(new Date(value.inspection_date)) || '') +'</td>';
					}
					tableData += '<td style="text-align:left">'+ value.vehicle_number +'</td>';
					tableData += '<td style="text-align:left">'+ value.employee_id +' - '+ value.employee_name +'</td>';
            ...
            tableData += '<a href="'+url+'/'+value.upload_image+'" target="_blank"><i class="fa fa-paperclip"></i></a>';
	           tableData += '</td>';
          }else{
            tableData += '<td style="text-align:center">';
	          tableData += '</td>';
