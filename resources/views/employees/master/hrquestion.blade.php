	...
	<div class="box box-solid">
		<div class="box-body">
			...
			<div class="col-xs-12" style="padding-top: 10px;">
				<div class="row">
					<div class="col-xs-3" id="left" style="padding: 0 5px 0 10px; height: 80vh;">
						<table class="table table-responsive" id="tabel">
						</table>
					</div>
					<div class="col-xs-9" id="right" style="height: 80vh;">
						<div id="chat">
						</div>
					</div>
				</div>
					...
					$.each(result.chats, function(index2, value2){
						if (chats[0] == value2.id) { 
							if (value2.message_detail) {
								...
								var reply = value2.created_at_new;

								if (value2.reply_date) {
									reply = value2.reply_date;
								}
								
								chat_history += '<span style="color:#999; font-size:13px">'+reply+'</span></span>';
