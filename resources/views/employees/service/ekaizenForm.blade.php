		...
		// console.log(data);
				...
				// if ($("kz_sub_leader").val() != '' && $("kz_judul").val() != '') {
					$.post('{{ url("post/ekaizen") }}', data, function(result, status, xhr){
						console.log('tes');
						$("#loading").hide();
						$("#kz_leader").val('').trigger('change');
						$("#kz_tujuan").val('').trigger('change');
						$("#kz_purpose").val('').trigger('change');
						$("#kz_judul").val('');
						CKEDITOR.instances.kz_sekarang.setData( '' );
						CKEDITOR.instances.kz_perbaikan.setData( '' );
