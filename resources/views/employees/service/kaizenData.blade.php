									...
									<div class="row">	
										<div class="col-md-4">
											<div class="form-group">
												...
												<select class="form-control select2" data-placeholder="Pilih Department" name="department" id="department" style="width: 100% height: 35px; font-size: 15px;">
													<option value=""></option>
										...
										<div class="col-md-4">
											<div class="form-group">
												<label>Section</label>
												<select class="form-control select2" data-placeholder="Pilih Section" name="section" id="section" style="width: 100% height: 35px; font-size: 15px;">
													<option value=""></option>
													@foreach($secs as $sec)
...
<script>
	...
	function fill_table(dari, sampai, nik, dept, sec) {
		...
		var table2 = $('#tableKaizen').DataTable({
			...
			"ajax": {
				"type" : "get",
				"data": { dari: dari, sampai: sampai, nik: nik, dept: dept, sec: sec},
	...
	function searching() {
		...
		fill_table(dari, sampai, nik, dept, sec);
	}
