...
<section class="content" style="padding-top: 0px;">
	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1">
			<div class="box">
				<div class="box-body">
					<h2 class="head">UPDATE DATA PERPAJAKAN & NPWP KARYAWAN YMPI 2023</h2>
					...
					<div class="form-group row" align="left">
						...
						<ol>
							...
							<li><span class="text-red">Status Pernikahan / Lajang</span>, Kondisi Per 01 Januari 2023</li>
					...
					<form id="form_pajak" method="post" action="upload" enctype="multipart/form-data">
						...
						<div class="form-group row" align="left">
							...
							<div class="col-xs-5" align="left">
								<input type="text" pattern="\d*" maxlength="16" class="form-control" id="nik" name="nik" placeholder="Nomor Induk Kependudukan. Contoh : 35730112323..." required>
							</div>
						</div>
						...
						<div class="form-group row" style="margin-top: 3%;background-color: #b464f5;color: white;padding: 10px;margin:10px;border-radius: 5px">
							<label class="col-xs-6 header-tab">B. Data Alamat (Sesuai KTP)</label>
						</div>
						...
						<div class="form-group row" style="margin-top: 3%;background-color: #b464f5;color: white;padding: 10px;margin:10px;border-radius: 5px">
							<label class="col-xs-12 header-tab">C. STATUS PERNIKAHAN DIISI SESUAI KONDISI PER 1 JANUARI 2023</label>
						</div>
						...
						<div class="col-xs-8" style="border-right:2px solid red">

							<div class="form-group row" align="left">
								<label class="col-xs-4 label-pad">Apakah anda sudah memiliki NPWP? <span class="text-red">*</span></label>
							...
							<div class="form-group row data_npwp" align="left">
								<label class="col-xs-4 label-pad">Apakah NPWP anda atas nama sendiri atau ikut NPWP suami? <span class="text-red">*</span></label>
								<div class="col-xs-8" align="left">
							...
							<div class="form-group row" align="left" id="perubahan_data" style="display: none;">
								<label class="col-xs-4 label-pad">Apakah Ada Perubahan Data NPWP <span class="keterangan_npwp"></span> ? <span class="text-red">*</span></label>
								<div class="col-xs-8" align="left">
									<label class="radio" style="margin-top: 5px;margin-left: 5px">Ada
										<input type="radio" id="npwp_change_status" name="npwp_change_status" value="Ada" onclick="checkJawaban()">
										<span class="checkmark"></span>
									</label>
									&nbsp;&nbsp;
									<label class="radio" style="margin-top: 5px">Tidak Ada
										<input type="radio" id="npwp_change_status" checked name="npwp_change_status" value="Tidak Ada" onclick="checkJawaban()">
										<span class="checkmark"></span>
									</label>
								</div>
							</div>
							...
							<div class="form-group row data_npwp" align="left">
								<label class="col-xs-4 label-pad">Nama sesuai NPWP <span class="keterangan_npwp"></span><span class="text-red">*</span></label>
								<div class="col-xs-8" align="left">
									<input type="text" class="form-control" id="npwp_nama" name="npwp_nama" placeholder="Nama Sesuai NPWP">
								<span class="text-red">*Pastikan Nama Sama dengan Kartu NPWP</span> 
								</div>
							</div>

							<div class="form-group row data_npwp" align="left">
								<label class="col-xs-4 label-pad">Nomor NPWP <span class="keterangan_npwp"></span><span class="text-red">*</span></label>
								<div class="col-xs-8" align="left">
									<input type="text" pattern="\d*" maxlength="16" class="form-control" id="npwp_nomor" name="npwp_nomor" placeholder="Contoh Penulisan : 948507199624000 (Tuliskan 15/16 Digit Angka)">
								</div>
							</div>

							<div class="form-group row data_npwp" align="left">
								<label class="col-xs-4 label-pad">Alamat Sesuai NPWP <span class="keterangan_npwp"></span><span class="text-red">*</span></label>
								<div class="col-xs-8" align="left">
							...
							<!-- <div class="form-group row data_npwp">
								<label class="col-xs-4 label-pad">Foto Kartu NPWP (Upload Foto kartu jika ada, format .jpg)</label>
						...
						<label class="col-xs-4 label-pad">Foto Kartu NPWP (format .jpg)</label>
						<div class="col-xs-4" align="left">
							<input type="file" id="attach" name="attach[]" multiple="" accept="image/*">
							<label><i class="fa fa-paperclip"></i> </label>
							<div id="file_upload" style="margin-left: 50px"></div>
						</div>
						<div class="col-xs-12">
							<div class="form-group row" align="center" style="margin-top: 5%; margin-bottom: 5%;">
								...
								<div class="col-xs-3 col-xs-offset-7"><!-- 
									...
									<button type="submit" class="btn btn-lg btn-success"><i class="fa fa-save"></i> KONFIRMASI</button>
								</div>
							</div>
						</div>
	...
	<div class="modal fade" id="modalBerita">
		<div class="modal-dialog modal-md modal-default" style="width: 50%;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
					<center><h4 class="modal-title"><b>Catatan Pengisian NPWP 2023</b></h4></center>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12" style="padding:0">
							<b>
							1. Mohon Update Status Perpajakan dan NPWP 2023 Kondisi Per 01 Januari 2023<br>
							2. Apabila Sudah Pernah Mengisi, Mohon Cek Kembali Data Pada Tahun 2022<br>
							3. Tekan Tombol <img src="{{url('images/konfirmasi.png')}}" width="90px"> sebagai bukti bahwa anda sudah melakukan pengecekan data NPWP<br>
							</b>
						</div>
					</div>
				</div>
		...
		$.get('{{ url("fetch/fill_perpajakan_data") }}', data, function(result, status, xhr){
			if(result.status){
				if(result.data != null){
					...
					if (result.data.npwp_change_status == "ADA") {
						$('#npwp_nama').val(result.data.npwp_nama_change).attr('readonly',true);
						$('#npwp_nomor').val(result.data.npwp_nomor_change).attr('readonly',true);
						$('#npwp_alamat').val(result.data.npwp_alamat_change).attr('readonly',true);
					}else{
						$('#npwp_nama').val(result.data.npwp_nama).attr('readonly',true);
						$('#npwp_nomor').val(result.data.npwp_nomor).attr('readonly',true);
						$('#npwp_alamat').val(result.data.npwp_alamat).attr('readonly',true);
					}

					if(result.data.npwp_nomor != null){
						$('#perubahan_data').show();
					}else{
						$('#perubahan_data').hide();
					}
		...
		$.ajax({
			...
			success:function(result, status, xhr){
				if(result.status){
					...
					$("#loading").hide();
					window.location.href = "{{url('index/employee/service?id=2&tahun=2023')}}";
				}else{
...
function checkJawaban(){
	if ($('input[id="npwp_change_status"]:checked').val() == "Ada") {
		$('#npwp_nama').attr('readonly',false);
		$('#npwp_nomor').attr('readonly',false);
		$('#npwp_alamat').attr('readonly',false);
	} else if ($('input[id="npwp_change_status"]:checked').val() == "Tidak Ada") {
		$('#npwp_nama').attr('readonly',true);
		$('#npwp_nomor').attr('readonly',true);
		$('#npwp_alamat').attr('readonly',true);
	}
}
