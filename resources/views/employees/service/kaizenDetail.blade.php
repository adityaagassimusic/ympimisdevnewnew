					...
					<div class="col-xs-12">
						<div class="row">
							...
							<div class="col-xs-6" style="padding: 0px 5px 0px 5px;">
								...
								<textarea id="before2" readonly></textarea>
							...
							<div class="col-xs-6" style="padding: 0px 5px 0px 5px">
								...
								<textarea id="after2" readonly></textarea>
	...
	<script>
		...
		function getKaizen(id) {
			...
			$.get('{{ url("fetch/kaizen/detail") }}', data, function(result) {
				...
				$("#before2").val(result.datas[0].condition);
				// $("#after").html(result.datas[0].improvement);
				$("#after2").val(result.datas[0].improvement);
				...
				CKEDITOR.replace('before2' ,{
					filebrowserImageBrowseUrl : '{{ url('kcfinder_master') }}',
					height : 500
				});

				CKEDITOR.replace('after2' ,{
					filebrowserImageBrowseUrl : '{{ url('kcfinder_master') }}',
					height : 500
				});
			})
