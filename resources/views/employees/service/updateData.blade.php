    ...
    <section class="content" style="padding-top: 0px;">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <h2 class="head">PENDATAAN ULANG DATA KARYAWAN PT. YMPI</h2>
                        ...
                        <form id="form_update" method="post" action="upload" enctype="multipart/form-data">
                            ...
                            <div class="form-group row" style="margin-top: 3%;">
                                ...
                                <label class="col-xs-4 label-pad" style="font-weight: bold; text-align: right;"><span
                                        class="text-red">*) : Harus Diisi</span></label>
                            </div>
                                ...
                                <div class="col-xs-3" align="left">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir"
                                            name="tanggal_lahir" placeholder="Pilih Tanggal Lahir" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <select class="form-control select2" data-placeholder="Pilih Status"
                                        id="jenis_kelamin" name="jenis_kelamin" style="width: 100%" required>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <select class="form-control select2" data-placeholder="Pilih Status" id="agama"
                                        name="agama" style="width: 100%" required>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <select class="form-control select2" data-placeholder="Pilih Status"
                                        id="status_perkawinan" name="status_perkawinan" style="width: 100%" required>
                            ...
                            <div class="form-group row" align="right">
                                <label class="col-xs-2 label-pad">Alamat Asal (Sesuai KTP)<span
                                        class="text-red">*</span></label>
                                <div class="col-xs-5" align="left">
                                    <textarea id="alamat_asal" name="alamat_asal" class="form-control" rows="3"
                                        placecholder="Alamat Asal (Sesuai KTP)" required></textarea>
                                </div>
                            </div>

                            <div class="form-group row" align="right">
                                <label class="col-xs-2 label-pad">Alamat Domisili (Sekarang)<span
                                        class="text-red">*</span></label>
                                <div class="col-xs-5" align="left">
                                    <textarea id="alamat_domisili" name="alamat_domisili" class="form-control" rows="3"
                                        placecholder="Alamat Domisili (Sekarang)" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <input type="number" class="form-control" id="telepon_rumah" name="telepon_rumah"
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <input type="number" class="form-control" id="hp" name="hp"
                                        placeholder="Nomor Hand Phone (Wajib Diisi)" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-5" align="left">
                                    <input type="email" class="form-control" id="email" name="email"
                                        placeholder="Alamat Email (Wajib Diisi)" required>
                                    <span class="text-red" style="font-weight:bold">*Email akan digunakan untuk menerima
                                        informasi slip gaji</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-3" align="left">
                                    <input type="text" class="form-control" id="faskes" name="faskes"
                            ...
                            <div class="form-group row" style="margin-top: 3%;">
                                <label class="col-xs-6 col-xs-offset-1 header-tab">B. Susunan Anggota Keluarga Anda
                                    (Termasuk diri anda sendiri)</label>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_ayah"
                                        name="kelamin_ayah" style="width: 100%" required>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_ayah"
                                        name="tempat_lahir_ayah" placeholder="Tempat Lahir Ayah">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_ayah"
                                            name="tanggal_lahir_ayah" placeholder="Tanggal Lahir Ayah">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_ibu"
                                        name="kelamin_ibu" style="width: 100%" required>
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_ibu"
                                        name="tempat_lahir_ibu" placeholder="Tempat Lahir Ibu">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_ibu"
                                            name="tanggal_lahir_ibu" placeholder="Tanggal Lahir Ibu">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara1" name="nama_saudara1"
                                        placeholder="Nama Saudara 1">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara1"
                                        name="kelamin_saudara1" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara1"
                                        name="tempat_lahir_saudara1" placeholder="Tempat Lahir Saudara 1">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara1"
                                            name="tanggal_lahir_saudara1" placeholder="Tanggal Lahir Saudara 1">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara1"
                                        name="pekerjaan_saudara1" placeholder="Pekerjaan Saudara 1">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara2" name="nama_saudara2"
                                        placeholder="Nama Saudara 2">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara2"
                                        name="kelamin_saudara2" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara2"
                                        name="tempat_lahir_saudara2" placeholder="Tempat Lahir Saudara 2">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara2"
                                            name="tanggal_lahir_saudara2" placeholder="Tanggal Lahir Saudara 2">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara2"
                                        name="pekerjaan_saudara2" placeholder="Pekerjaan Saudara 2">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara3" name="nama_saudara3"
                                        placeholder="Nama Saudara 3">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara3"
                                        name="kelamin_saudara3" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara3"
                                        name="tempat_lahir_saudara3" placeholder="Tempat Lahir Saudara 3">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara3"
                                            name="tanggal_lahir_saudara3" placeholder="Tanggal Lahir Saudara 3">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara3"
                                        name="pekerjaan_saudara3" placeholder="Pekerjaan Saudara 3">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara4" name="nama_saudara4"
                                        placeholder="Nama Saudara 4">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara4"
                                        name="kelamin_saudara4" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara4"
                                        name="tempat_lahir_saudara4" placeholder="Tempat Lahir Saudara 4">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara4"
                                            name="tanggal_lahir_saudara4" placeholder="Tanggal Lahir Saudara 4">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara4"
                                        name="pekerjaan_saudara4" placeholder="Pekerjaan Saudara 4">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara5" name="nama_saudara5"
                                        placeholder="Nama Saudara 5">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara5"
                                        name="kelamin_saudara5" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara5"
                                        name="tempat_lahir_saudara5" placeholder="Tempat Lahir Saudara 5">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara5"
                                            name="tanggal_lahir_saudara5" placeholder="Tanggal Lahir Saudara 5">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara5"
                                        name="pekerjaan_saudara5" placeholder="Pekerjaan Saudara 5">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara6" name="nama_saudara6"
                                        placeholder="Nama Saudara 6">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara6"
                                        name="kelamin_saudara6" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara6"
                                        name="tempat_lahir_saudara6" placeholder="Tempat Lahir Saudara 6">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara6"
                                            name="tanggal_lahir_saudara6" placeholder="Tanggal Lahir Saudara 6">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara6"
                                        name="pekerjaan_saudara6" placeholder="Pekerjaan Saudara 6">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara7" name="nama_saudara7"
                                        placeholder="Nama Saudara 7">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara7"
                                        name="kelamin_saudara7" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara7"
                                        name="tempat_lahir_saudara7" placeholder="Tempat Lahir Saudara 7">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara7"
                                            name="tanggal_lahir_saudara7" placeholder="Tanggal Lahir Saudara 7">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara7"
                                        name="pekerjaan_saudara7" placeholder="Pekerjaan Saudara 7">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara8" name="nama_saudara8"
                                        placeholder="Nama Saudara 8">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara8"
                                        name="kelamin_saudara8" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara8"
                                        name="tempat_lahir_saudara8" placeholder="Tempat Lahir Saudara 8">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara8"
                                            name="tanggal_lahir_saudara8" placeholder="Tanggal Lahir Saudara 8">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara8"
                                        name="pekerjaan_saudara8" placeholder="Pekerjaan Saudara 8">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara9" name="nama_saudara9"
                                        placeholder="Nama Saudara 9">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara9"
                                        name="kelamin_saudara9" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara9"
                                        name="tempat_lahir_saudara9" placeholder="Tempat Lahir Saudara 9">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_saudara9"
                                            name="tanggal_lahir_saudara9" placeholder="Tanggal Lahir Saudara 9">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara9"
                                        name="pekerjaan_saudara9" placeholder="Pekerjaan Saudara 9">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara10" name="nama_saudara10"
                                        placeholder="Nama Saudara 10">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara10"
                                        name="kelamin_saudara10" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara10"
                                        name="tempat_lahir_saudara10" placeholder="Tempat Lahir Saudara 10">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker"
                                            id="tanggal_lahir_saudara10" name="tanggal_lahir_saudara10"
                                            placeholder="Tanggal Lahir Saudara 10">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara10"
                                        name="pekerjaan_saudara10" placeholder="Pekerjaan Saudara 10">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara11" name="nama_saudara11"
                                        placeholder="Nama Saudara 11">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara11"
                                        name="kelamin_saudara11" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara11"
                                        name="tempat_lahir_saudara11" placeholder="Tempat Lahir Saudara 11">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker"
                                            id="tanggal_lahir_saudara11" name="tanggal_lahir_saudara11"
                                            placeholder="Tanggal Lahir Saudara 11">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara11"
                                        name="pekerjaan_saudara11" placeholder="Pekerjaan Saudara 11">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_saudara12" name="nama_saudara12"
                                        placeholder="Nama Saudara 12">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_saudara12"
                                        name="kelamin_saudara12" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_saudara12"
                                        name="tempat_lahir_saudara12" placeholder="Tempat Lahir Saudara 12">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker"
                                            id="tanggal_lahir_saudara12" name="tanggal_lahir_saudara12"
                                            placeholder="Tanggal Lahir Saudara 12">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_saudara12"
                                        name="pekerjaan_saudara12" placeholder="Pekerjaan Saudara 12">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_pasangan"
                                        name="kelamin_pasangan" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_pasangan"
                                        name="tempat_lahir_pasangan" placeholder="Tempat Lahir Pasangan">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_pasangan"
                                            name="tanggal_lahir_pasangan" placeholder="Tanggal Lahir Pasangan">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_pasangan"
                                        name="pekerjaan_pasangan" placeholder="Pekerjaan Pasangan">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak1"
                                        name="kelamin_anak1" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak1"
                                        name="tempat_lahir_anak1" placeholder="Tempat Lahir Anak 1">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak1"
                                            name="tanggal_lahir_anak1" placeholder="Tanggal Lahir Anak 1">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak1"
                                        name="pekerjaan_anak1" placeholder="Pekerjaan Anak 1">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak2" name="nama_anak2"
                                        placeholder="Nama Anak 2">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak2"
                                        name="kelamin_anak2" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak2"
                                        name="tempat_lahir_anak2" placeholder="Tempat Lahir Anak 2">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak2"
                                            name="tanggal_lahir_anak2" placeholder="Tanggal Lahir Anak 2">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak2"
                                        name="pekerjaan_anak2" placeholder="Pekerjaan Anak 2">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak3" name="nama_anak3"
                                        placeholder="Nama Anak 3">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak3"
                                        name="kelamin_anak3" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak3"
                                        name="tempat_lahir_anak3" placeholder="Tempat Lahir Anak 3">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak3"
                                            name="tanggal_lahir_anak3" placeholder="Tanggal Lahir Anak 3">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak3"
                                        name="pekerjaan_anak3" placeholder="Pekerjaan Anak 3">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak4" name="nama_anak4"
                                        placeholder="Nama Anak 4">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak4"
                                        name="kelamin_anak4" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak4"
                                        name="tempat_lahir_anak4" placeholder="Tempat Lahir Anak 4">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak4"
                                            name="tanggal_lahir_anak4" placeholder="Tanggal Lahir Anak 4">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak4"
                                        name="pekerjaan_anak4" placeholder="Pekerjaan Anak 4">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak5" name="nama_anak5"
                                        placeholder="Nama Anak 5">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak5"
                                        name="kelamin_anak5" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak5"
                                        name="tempat_lahir_anak5" placeholder="Tempat Lahir Anak 5">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak5"
                                            name="tanggal_lahir_anak5" placeholder="Tanggal Lahir Anak 5">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak5"
                                        name="pekerjaan_anak5" placeholder="Pekerjaan Anak 5">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak6" name="nama_anak6"
                                        placeholder="Nama Anak 6">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak6"
                                        name="kelamin_anak6" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak6"
                                        name="tempat_lahir_anak6" placeholder="Tempat Lahir Anak 6">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak6"
                                            name="tanggal_lahir_anak6" placeholder="Tanggal Lahir Anak 6">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak6"
                                        name="pekerjaan_anak6" placeholder="Pekerjaan Anak 6">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="nama_anak7" name="nama_anak7"
                                        placeholder="Nama Anak 7">
                                </div>
                                <div class="col-xs-1" align="left" style="padding-left: 0px;">
                                    <select class="form-control select2" data-placeholder="L/P" id="kelamin_anak7"
                                        name="kelamin_anak7" style="width: 100%">
                                        <option style="color:grey;" value="">L/P</option>
                                        <option value="L">L</option>
                                        <option value="P">P</option>
                                    </select>
                                ...
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="tempat_lahir_anak7"
                                        name="tempat_lahir_anak7" placeholder="Tempat Lahir Anak 7">
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <div class="input-group date">
                                        <div class="input-group-addon bg-green" style="border: none;">
                                        ...
                                        <input type="text" class="form-control datepicker" id="tanggal_lahir_anak7"
                                            name="tanggal_lahir_anak7" placeholder="Tanggal Lahir Anak 7">
                                    </div>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_anak7"
                                        name="pekerjaan_anak7" placeholder="Pekerjaan Anak 7">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="sd_masuk"
                                        name="sd_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="sd_lulus"
                                        name="sd_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="smp_masuk"
                                        name="smp_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="smp_lulus"
                                        name="smp_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="sma_jurusan" name="sma_jurusan"
                                        placeholder="Jurusan">
                                </div>

                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="sma_masuk"
                                        name="sma_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="sma_lulus"
                                        name="sma_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="s1_jurusan" name="s1_jurusan"
                                        placeholder="Jurusan">
                                </div>

                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="s1_masuk"
                                        name="s1_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="s1_lulus"
                                        name="s1_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="s2_jurusan" name="s2_jurusan"
                                        placeholder="Jurusan">
                                </div>

                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="s2_masuk"
                                        name="s2_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="s2_lulus"
                                        name="s2_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                ...
                                <div class="col-xs-2" align="left">
                                    <input type="text" class="form-control" id="s3_jurusan" name="s3_jurusan"
                                        placeholder="Jurusan">
                                </div>

                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control yearpicker" id="s3_masuk"
                                        name="s3_masuk" placeholder="Tahun Masuk">
                                </div>

                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="number" class="form-control yearpicker" id="s3_lulus"
                                        name="s3_lulus" placeholder="Tahun Lulus">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="margin-top: 3%;">
                                <label class="col-xs-9 col-xs-offset-1 header-tab">E. Kondisi Darurat Yang Bisa Dihubungi
                                    (Wajib Diisi)</label>
                                <label class="col-xs-9 col-xs-offset-1 header-tab">&nbsp;&nbsp;&nbsp;&nbsp; Sebutkan
                                    nama-nama orang yang dapat dihubungi ketika ada kondisi emergency</label>
                            </div>

                            {{-- Darurat1 --}}
                            <div class="form-group row" align="right">
                                <div class="col-xs-2 col-xs-offset-2" align="left">
                                    <input type="text" class="form-control" id="nama_darurat1"
                                        name="nama_darurat1" placeholder="Nama" required>
                                </div>
                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control" id="telp_darurat1"
                                        name="telp_darurat1" placeholder="Nomor Telepon" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_darurat1"
                                        name="pekerjaan_darurat1" placeholder="Pekerjaan" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="hubungan_darurat1"
                                        name="hubungan_darurat1" placeholder="Hubungan" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                <div class="col-xs-2 col-xs-offset-2" align="left">
                                    <input type="text" class="form-control" id="nama_darurat2"
                                        name="nama_darurat2" placeholder="Nama" required>
                                </div>
                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control" id="telp_darurat2"
                                        name="telp_darurat2" placeholder="Nomor Telepon" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_darurat2"
                                        name="pekerjaan_darurat2" placeholder="Pekerjaan" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="hubungan_darurat2"
                                        name="hubungan_darurat2" placeholder="Hubungan" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="right">
                                <div class="col-xs-2 col-xs-offset-2" align="left">
                                    <input type="text" class="form-control" id="nama_darurat3"
                                        name="nama_darurat3" placeholder="Nama" required>
                                </div>
                                <div class="col-xs-2" align="left">
                                    <input type="number" class="form-control" id="telp_darurat3"
                                        name="telp_darurat3" placeholder="Nomor Telepon" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="pekerjaan_darurat3"
                                        name="pekerjaan_darurat3" placeholder="Pekerjaan" required>
                                </div>
                                <div class="col-xs-2" align="left" style="padding-left: 0px;">
                                    <input type="text" class="form-control" id="hubungan_darurat3"
                                        name="hubungan_darurat3" placeholder="Hubungan" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row" align="center" style="margin-top: 5%; margin-bottom: 10%;">
                                <div class="col-xs-6 col-xs-offset-6">
                                    <a style="margin-right: 3%;" class="btn btn-danger"
                                        href="{{ route('emp_service', ['id' => '1']) }}"><i class="fa fa-close"></i>
                                        CANCEL</a>
            ...
            $.get('{{ url('fetch/fill_emp_data') }}', data, function(result, status, xhr) {
                if (result.status) {
                    if (result.data != null) {
                        ...
                        $('#jenis_kelamin').val(result.data.gender).trigger('change.select2');
