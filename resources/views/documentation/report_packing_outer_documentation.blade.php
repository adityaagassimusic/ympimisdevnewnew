    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          Apakah anda yakin ingin delete data?
        </div>
...
<script>
  ...
  function fillTable(){
    ...
    $.get('{{ url("fetch/report/packing_outer_documentation") }}', data, function(result, status, xhr){
      ...
      $.each(result.lists, function(key, value) {
         ...
         tableData += '<td>'+ (value.material_number || "") +'</td>';
          ...
          if (value.photo != null) {
            ...
            //   tableData += '<a target="_blank" href="{{ url("images/packing_outer") }}/'+data[i]+'"><i class="fa fa-paperclip"></i>';
            // }
     ...
     function modalImage(data) {
      ...
      // var photos = '';
      // var url = '{{ url("images/packing_outer") }}';
      
      // for (var i = 0; i < photo.length; i++) {
      //   photos += '<img style="width:400px" src="'+url+'/'+photo[i]+'" class="user-image" alt="User image" >';
      //   photos += '&nbsp;&nbsp;&nbsp;';
      // }
      // $('#images').html(photos);
    ...
    for (var i = 0; i < photo.length; i++) {
      ...
      var result = doesFileExist("http://10.109.52.4/mirai/public/images/packing_outer/"+ photo[i]);
      
      if (result == true) {
        photos += '<img style="width:400px" src="http://10.109.52.4/mirai/public/images/packing_outer/'+photo[i]+'" class="user-image" alt="User image" >';
        photos += '&nbsp;&nbsp;&nbsp;';
      } else {
        photos += '<img style="width:400px" src="http://10.109.52.3/mirai/public/images/packing_outer/'+photo[i]+'" class="user-image" alt="User image" >';
        photos += '&nbsp;&nbsp;&nbsp;';
      }
    ...
    function delete_data_packing(id){
      ...
      $.post('{{ url("delete/packing_outer_documentation") }}', data, function(result, status, xhr){
