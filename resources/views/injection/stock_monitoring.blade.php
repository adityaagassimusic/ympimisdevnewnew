	...
	<div class="row">
		<div class="col-xs-12" style="margin-top: 0px;padding-left: 0px">
			...
			<div class="col-xs-4" style="padding-left: 15px">
				<table class="table table-bordered" id="tableResume2" style="width: 72vh">
					<!-- <tr>
						<th rowspan="2">RC91</th>
						<th>Plan</th>
					</tr>
			...
			if(xhr.status == 200){
				if(result.status){
				   ...
				   //          },
					...
					tableResume += '<thead>';
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">Item</th>';
					for (var i = 0; i < result.datas_skeleton.length; i++) {
						var color1_skeleton = result.datas_skeleton[i].part.split(' ');
						var color2_skeleton = color1_skeleton.slice(-1);
						if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume += '</tr>';
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">RC11 Plan</th>';
						for (var i = 0; i < result.datas_skeleton.length; i++) {
							var color1_skeleton = result.datas_skeleton[i].part.split(' ');
							var color2_skeleton = color1_skeleton.slice(-1);
							if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume += '</tr>';
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">RC11 Act</th>';
						for (var i = 0; i < result.datas_skeleton.length; i++) {
							var color1_skeleton = result.datas_skeleton[i].part.split(' ');
							var color2_skeleton = color1_skeleton.slice(-1);
							if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">Avail</th>';
						for (var i = 0; i < result.datas_skeleton.length; i++) {
							var color1_skeleton = result.datas_skeleton[i].part.split(' ');
							var color2_skeleton = color1_skeleton.slice(-1);
							if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">RC91 Plan</th>';
						for (var i = 0; i < result.datas_skeleton.length; i++) {
							var color1_skeleton = result.datas_skeleton[i].part.split(' ');
							var color2_skeleton = color1_skeleton.slice(-1);
							if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume += '</tr>';
					tableResume += '<tr>';
						tableResume += '<th style="padding:3px;width:60px;background-color:white;color:black;text-align:left">RC91 Act</th>';
						for (var i = 0; i < result.datas_skeleton.length; i++) {
							var color1_skeleton = result.datas_skeleton[i].part.split(' ');
							var color2_skeleton = color1_skeleton.slice(-1);
							if (result.datas_skeleton[i].color == 'BLUE)') {
					...
					tableResume2 += '<tr>';
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">Item</th>';
					tableResume2 += '</tr>';
					tableResume2 += '<tr>';
						for (var i = 0; i < result.datas_ivory.length; i++) {
							var color1_ivory = result.datas_ivory[i].part.split(' ');
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">RC11 Plan</th>';
					tableResume2 += '</tr>';
					tableResume2 += '<tr>';
						for (var i = 0; i < result.datas_ivory.length; i++) {
							var color1_ivory = result.datas_ivory[i].part.split(' ');
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">RC11 Act</th>';
					tableResume2 += '</tr>';
					...
					tableResume2 += '<tr>';
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">Avail</th>';
					tableResume2 += '</tr>';
					...
					tableResume2 += '<tr>';
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">RC91 Plan</th>';
					tableResume2 += '</tr>';
					...
					tableResume2 += '<tr>';
						...
						tableResume2 += '<th style="padding:3px;width:70px;background-color:white;color:black;text-align:left">RC91 Act</th>';
					tableResume2 += '</tr>';
