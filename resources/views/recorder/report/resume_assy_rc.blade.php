...
<section class="content-header">
	<h1>
		Resume Recorder<span class="text-purple">??</span>
		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title">Resume Filters <span class="text-purple">Record フィルター</span></h3>
				</div>
				...
				<div class="box-body">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" placeholder="Date From" class="form-control pull-right" id="datefrom" name="datefrom">
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" placeholder="Date To" class="form-control pull-right" id="dateto" name="dateto">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<table id="rc_detail_table" class="table table-bordered table-striped table-hover">
...
<script>
	...
	function fillFloDetail(){
		$('#rc_detail_table').DataTable().destroy();
		...
		$('#rc_detail_table').DataTable({
			...
			"processing": true,
				...
				"ajax": {
					"type" : "post",
					"url" : "{{ url("recorder/filter_assy_rc") }}",
					"data" : data,
				},
				"columns": [
				{ "data": "model" },
