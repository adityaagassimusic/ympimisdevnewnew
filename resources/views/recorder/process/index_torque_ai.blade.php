							...
							<div class="col-xs-4" style="padding-top: 20px" id="tanggal_injeksi_head">
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="row">
											<div class="col-xs-12">
												<input id="injection_date_head" style="font-size: 20px; height: 40px; text-align: center;" type="text" class="form-control" placeholder="Tanggal Injeksi Head" readonly>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-xs-4" style="padding-top: 20px" id="tanggal_injeksi_foot">
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="row">
											<div class="col-xs-12">
												<input id="injection_date_foot" style="font-size: 20px; height: 40px; text-align: center;" type="text" class="form-control" placeholder="Tanggal Injeksi Foot" readonly>
											</div>
										</div>
									</div>
								</div>
...
<script>
	...
	function confirm() {
		if ($('#product_fix2').text() == "YRF-21K//ID" || $('#product_fix2').text() ==  "YRF-21//ID" || $('#product_fix2').text() == "YRF-21 (FSA)") {
			...
			if($('#injection_date_middle').val() == '' || $('#injection_date_head').val() == '' || $('#injection_date_foot').val() == '' || $('#middle_id').val() == '' || $('#head_id').val() == '' || $('#foot_id').val() == '' || $('#mesin_middle_fix2').text() == '#0' || $('#mesin_head_fix2').text() == '#0' || $('#mesin_foot_fix2').text() == '#0' || $('#product_fix2').text() == 'YRS'){
				alert('Semua Data Harus Diisi.');
			}else{
				$('#prod_type').html($('#product_fix2').text());
				$('#injection_date_middle_fix').html($('#injection_date_middle').val());
		...
		$.get('{{ url("index/fetchResumeTorqueAi") }}', data, function(result, status, xhr){
			...
			for(var i=0;i<4;i++){
				for(var j=0;j<indexHeadFoot;j++){
					...
					tableData += '<td style="padding:0;text-align:right"><input type="number" style="font-size: 15px; height: 100%; text-align: center;" onkeyup="torquemf(this.id)" class="form-control" id="torquemf_1_'+index+'"></td>';
					tableData += '<td style="padding:0;text-align:right"><input type="number" style="font-size: 15px; height: 100%; text-align: center;" onkeyup="torquemf(this.id)" class="form-control" id="torquemf_2_'+index+'"></td>';
					tableData += '<td style="padding:0;text-align:right"><input type="number" style="font-size: 15px; height: 100%; text-align: center;" onkeyup="torquemf(this.id)" class="form-control" id="torquemf_3_'+index+'"></td>';
