							...
							<div class="col-xs-6">
								<div class="row">
									...
									<div class="col-xs-12">
										<div class="row">
											<div class="col-xs-12">
												<input id="injection_date_block" style="font-size: 20px; height: 40px; text-align: center;" type="text" class="form-control" placeholder="Tanggal Injeksi Block" readonly>
											</div>
										</div>
									</div>
								</div>
