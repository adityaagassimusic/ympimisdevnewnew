...
<section class="content-header" style="text-align: center;">
	...
	<span style="font-size: 3vw; color: red;"><i class="fa fa-angle-double-down"></i> Saxophone NG <i class="fa fa-angle-double-down"></i></span>
</section>
@stop
@section('content')
...
<script>
	...
	function scanSerialNumber(){
		...
		$.post('{{ url("scan/serial_number_ng_Sx") }}', data, function(result, status, xhr){
			console.log(status);
			console.log(result);
			console.log(xhr);
			if(xhr.status == 200){
