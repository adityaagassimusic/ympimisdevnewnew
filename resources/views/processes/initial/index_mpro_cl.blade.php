...
<section class="content-header">
	<h1>
		Clarinet Material Process<span class="text-purple"> クラリネットの部品加工</span>
...
<section class="content">
	<div class="row">
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url("index/press/create", "Clarinet") }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: green;">Press Machine Clarinet</a>
		</div>
