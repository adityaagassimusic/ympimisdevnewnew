...
<section class="content-header" style="text-align: center;">
	<span style="font-size: 3vw; color: red;"><i class="fa fa-angle-double-down"></i> Lacquering Target <i class="fa fa-angle-double-down"></i></span>
</section>
@stop
@section('content')
...
<script>
	...
	function fillTable(){
		...
		$.get('{{ url("fetch/middle/buffing_target", "lcq") }}', function(result, status, xhr) {
			if(result.status){
