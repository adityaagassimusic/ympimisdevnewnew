...
@section('header')
    <section class="content-header" style="text-align: center;">
        <span style="font-size: 3vw; color: red;"><i class="fa fa-angle-double-down"></i> Plating Target <i
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button class="btn btn-success" onclick="edit()"><span><i class="fa fa-save"></i>
                                Save</span></button>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        function fillTable() {
            ...
            $.get('{{ url('fetch/middle/buffing_target', 'plt') }}', function(result, status, xhr) {
                if (result.status) {
                    ...
                    for (var i = 0; i < result.target.length; i++) {
                        ...
                        tableData += '<button style="width: 50%;" onClick="showModal(this)" id="' + result.target[i]
                            .id + '+' + result.target[i].target_name + '+' + result.target[i].location + '+' +
                            result.target[i].target + '+' + result.target[i].unit +
