						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" class="form-control pull-right" id="datefrom" name="datefrom" style="font-size: 0.8vw;">
								</div>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" class="form-control pull-right" id="dateto" name="dateto" style="font-size: 0.8vw;">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-md-12">
							<table id="report" class="table table-bordered table-striped table-hover">
								<thead style="background-color: rgba(126,86,134,.7);">
									<tr>
										<th style="width: 1%">Operator ID</th>
										...
										<th style="width: 1%">Check ID</th>
										<th style="width: 8%">Check By</th>
...
<script>
	...
	function fillTable(){
		...
		var table = $('#report').DataTable({
			...
			"ajax": {
				"type" : "get",
				"url" : "{{ url("fetch/middle/report_production_result") }}",
				"data" : data
			},
			"columns": [
			{ "data": "operator_id" },
