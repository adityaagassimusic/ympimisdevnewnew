						...
						<div class="col-md-12">
							<table id="report" class="table table-bordered table-striped table-hover">
								<thead style="background-color: rgba(126,86,134,.7);">
									<tr>
										<th width="5%">Operator ID</th>
										<th width="15%">Operator Name</th>
										<th width="5%">Material Number</th>
										<th width="5%">Model</th>
										<th width="5%">Key</th>
										<th width="20%">NG</th>
										<th width="5%">Buffing Time</th>
										<th width="15%">Trainer</th>
										<th width="15%">Operator Kensa</th>
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script>
	...
	function fillTable(){
		...
		var table = $('#report').DataTable({
			...
			"ajax": {
				"type" : "get",
				"url" : "{{ url("fetch/middle/report_buffing_traing_ng_operator") }}",
				"data" : data
			},
			"columns": [
			{ "data": "operator_id" },
