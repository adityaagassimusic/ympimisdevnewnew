				...
				<table class="table table-bordered">
					<thead style="background-color: rgb(126,86,134); color: #FFD700;">
						<tr>
							...
							<th style="width: 1%; padding: 0;">Category</th>
...
<script>
	...
	function returnBarrel(qr) {
		...
		$.get('{{ url("input/middle/body_return") }}', data, function(result, status, xhr){
			if (result.status) {
	...
	function filltable() {
		...
		$.get('{{ url("fetch/middle_return/surface_return") }}', data, function(result, status, xhr){
