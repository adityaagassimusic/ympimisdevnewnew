...
<section class="content" style="padding-top: 0;">
	...
	<div class="row">
		<div class="col-xs-12" style="padding-bottom: 5px;">
			<div class="row">
				<!-- <form method="GET" action="{{ action('AssemblyProcessController@indexOpClarinetRate') }}"> -->
		...
		<div class="col-xs-12" style="margin-top: 1%;">
			<div id="container_1" class="container" style="width: 100%;height: 500px"></div>
		</div>
		<div class="col-xs-6" style="margin-top: 1%;">
			<div id="container_2" class="container" style="width: 100%;height: 500px"></div>
		</div>
		<div class="col-xs-6" style="margin-top: 1%;">
			<div id="container_3" class="container" style="width: 100%;height: 500px"></div>
		</div>
		<div class="col-xs-6" style="margin-top: 1%;">
			<div id="container_4" class="container" style="width: 100%;height: 500px"></div>
		</div>
		<div class="col-xs-6" style="margin-top: 1%;">
			<div id="container_5" class="container" style="width: 100%;height: 500px"></div>
		</div>
	</div>
</section>
...
<script>
	...
	function fetchChart(){
		...
		$.get('{{ url("fetch/assembly/saxophone/op_ng") }}', data, function(result, status, xhr) {
			if(result.status){
				...
				for(var j = 1; j < 6;j++){
					...
					Highcharts.chart('container_'+j, {
						chart: {
							animation: false
						},
						title: {
							text: 'NG Rate By Operator Line '+j,
							style: {
								fontSize: '25px',
								fontWeight: 'bold'
							}
