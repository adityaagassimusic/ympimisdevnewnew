...
<section class="content-header" style="text-align: center;">
	...
	<span style="font-size: 3vw; color: red;"><i class="fa fa-angle-double-down"></i> {{$title}} <i class="fa fa-angle-double-down"></i></span>
</section>
@stop
@section('content')
	...
	<div class="row">
		<div class="col-xs-12" style="text-align: center;">
			<div class="input-group col-md-8 col-md-offset-2">
				...
				<input type="text" style="text-align: center; border-color: red; font-size: 3vw; height: 70px" class="form-control" id="serialNumber" name="serialNumber" placeholder="Scan RFID / Ketik Serial Number" required>
				<div class="input-group-addon" id="icon-serial" style="font-weight: bold; font-size: 3vw; border-color: red;">
					<i class="glyphicon glyphicon-barcode"></i>
				</div>
			</div>
...
<script>
	...
	function scanSerialNumber(){
		...
		$.post('{{ url("scan/assembly/return") }}', data, function(result, status, xhr){
			if(xhr.status == 200){
				if(result.status){
					$("#serialNumber").val("");
					$("#serialNumber").focus();
