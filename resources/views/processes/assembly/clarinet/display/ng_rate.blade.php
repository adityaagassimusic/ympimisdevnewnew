		...
		<div class="col-xs-12" style="padding-bottom: 5px;">
			<!-- <div class="row"> -->
				<!-- <div id="period_title" class="col-xs-3" style="background-color: rgba(138, 63, 181,0.9);">
		            <center><span style="color: white; font-size: 1px; font-weight: bold;" id="title_text"></span></center>
		        </div> -->
...
<script>
	...
	function fetchChart(){
		...
		$.get('{{ url("fetch/assembly/clarinet/ng_rate") }}', data, function(result, status, xhr) {
			if(result.status){
...
// 		$.get('{{ url("fetch/assembly/clarinet/ng_rate/line") }}', data, function(result, status, xhr) {
// 			if(result.status){
...
function ShowModal(cat,date,type) {
	...
	$.get('{{ url("fetch/assembly/clarinet/ng_rate_detail") }}', data, function(result, status, xhr) {
		if(result.status){
