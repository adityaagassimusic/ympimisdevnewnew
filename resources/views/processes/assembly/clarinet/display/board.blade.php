		...
		$.get('{{ url("fetch/assembly/clarinet/board") }}', data, function(result, status, xhr){
			if(xhr.status == 200){
				if(result.status){
					...
					$.each(result.boards, function(index, value){
						if (i % 2 === 0 ) {
							if (value.employee_id) {
								...
								if (value.sedang == "<br>"){
									...
									color3 = 'style="color:#a4fa98;font-size:25px"';
						...
						if (value.employee_id == null) {
							...
							// }else{
								...
								assemblyTableBody += '</td>';
								assemblyTableBody += '<td style="font-size:35px;">'+perolehan;
								assemblyTableBody += '</td>';
							// }
						}
					...
					assemblyTableBody += '<tr>';
					assemblyTableBody += '<td colspan="3" height="5%" style="font-size:35px;background-color:white;color:black;">TOTAL PEROLEHAN</td>';
					assemblyTableBody += '<td height="5%" style="font-size:35px;background-color:white;color:black;">'+perolehans+'</td>';
					assemblyTableBody += '</tr>';
