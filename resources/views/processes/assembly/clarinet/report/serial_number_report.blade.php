							...
							<table id="tableNgReportFungsi" class="table table-bordered table-striped table-hover">
								<thead style="background-color: rgba(126,86,134,.7);">
									<tr>
										...
										<th>Model Packing</th>
										<th>Japan</th>
										<th>Cek Kensa Produksi</th>
										<th>Operator QA Kensa</th>
										<th>Datetime QA Kensa</th>
										<th>Result QA Kensa</th>
										<th>NG</th>
										<th>Kunci</th>
										<th>Value</th>
										<th>Lokasi</th>
...
<script>
	...
	function fillData(){
		...
		url	= '{{ url("fetch/assembly/cl/serial_number_report") }}'+'/'+proces;
				...
				if (result.report_fungsi != null) {
					...
					$.each(result.report_fungsi, function(key, value) {
						if (value.ng_name ==  null) {
							...
							if (value.status_material != null) {
								if (value.model_packing.match(/450/gi) || value.model_packing.match(/400AD/gi)) {
									tableDataFungsi += '<td>'+ value.status_material.split(',')[0] +'</td>';
								}else{
							...
							if (value.status_material != null) {
								if (value.model_packing.match(/450/gi) || value.model_packing.match(/400AD/gi)) {
									tableDataFungsi += '<td>'+ value.status_material.split(',')[1].split('/')[0] +'</td>';
									tableDataFungsi += '<td>'+ value.status_material.split(',')[1].split('/')[1] +'</td>';
									tableDataFungsi += '<td>'+ value.status_material.split(',')[1].split('/')[2] +'</td>';
									tableDataFungsi += '<td>'+ value.status_material.split(',')[1].split('/')[3] +'</td>';
								}else{
									tableDataFungsi += '<td></td>';
									tableDataFungsi += '<td></td>';
									tableDataFungsi += '<td></td>';
							...
							if (value.ng_name.match(/,/gi)) {
								...
								for(var i = 0; i < ngs.length;i++){
									...
									}else if (ngs[i].split('_')[0] == 'Renraku' || ngs[i].split('_')[0] == 'Renraku (PR)' || ngs[i].split('_')[0] == 'Kagi Atari' || ngs[i].split('_')[0] == 'Kagi Atari (PR)' || ngs[i].split('_')[0] == 'Susunan' || ngs[i].split('_')[0] == 'Celah') {
										tableDataFungsi += '<td>'+ngs[i].split('_')[0]+'</td>';
										tableDataFungsi += '<td>'+ngs[i].split('_')[2]+'-'+ngs[i].split('_')[3]+'</td>';
										tableDataFungsi += '<td></td>';
										tableDataFungsi += '<td>'+ngs[i].split('_')[4]+'</td>';
								...
								}else if (value.ng_name.split('_')[0] == 'Renraku' || value.ng_name.split('_')[0] == 'Renraku (PR)' || value.ng_name.split('_')[0] == 'Susunan' || value.ng_name.split('_')[0] == 'Celah' || value.ng_name.split('_')[0] == 'Kagi Atari' || value.ng_name.split('_')[0] == 'Kagi Atari (PR)') {
									tableDataFungsi += '<td>'+value.ng_name.split('_')[0]+'</td>';
									tableDataFungsi += '<td>'+value.ng_name.split('_')[2]+'-'+value.ng_name.split('_')[3]+'</td>';
									tableDataFungsi += '<td></td>';
									tableDataFungsi += '<td>'+value.ng_name.split('_')[4]+'</td>';
