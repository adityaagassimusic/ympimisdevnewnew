					...
					<div class="row">
						<div class="col-md-3 col-md-offset-1">
							...
							<div class="form-group">
								<div class="input-group date">
									...
									<input type="text" class="form-control datepicker" id="date" placeholder="Select Date" autocomplete="off">
								</div>
							</div>
						</div>
						<div class="col-md-3">
						...
						<div class="col-md-8 col-md-offset-2">
							<div class="form-group pull-right">
								...
								<a href="{{ url('index/assembly/status_material/'.$origin_group_code) }}" class="btn btn-danger">Clear</a>
...
<script>
	...
	function fillList(){
		...
		$.get('{{ url("fetch/assembly/status_material") }}',data, function(result, status, xhr){
			if(result.status){
				...
				var tableData = "";
				var index = 1;
				$.each(result.status_material, function(key, value) {
					tableData += '<tr>';
					...
					for(var i = 0; i < result.emp.length;i++){
						if (value.created_by == result.emp[i].employee_id) {
							name = result.emp[i].name;
						}
					}
					tableData += '<td style="text-align:left;padding-left:5px;">'+ value.status_material+'</td>';
					tableData += '<td style="text-align:left;padding-left:5px;">'+ value.created_by+' - '+ name+'</td>';
					tableData += '<td style="text-align:left;padding-left:5px;">'+ value.created_at +'</td>';
					tableData += '</tr>';
					index++;
				});
