...
<section class="content-header" style="text-align: center;">
	<span style="font-size: 3vw; color: red;"><i class="fa fa-angle-double-down"></i> BPP Target <i class="fa fa-angle-double-down"></i></span>
</section>
@stop
@section('content')
...
<script>
	...
	function fillTable(){
		...
		$.get('{{ url("fetch/body_parts_process/bpro_target") }}', data, function(result, status, xhr) {
			if(result.status){
	...
	function edit(){
		...
		$.post('{{ url("update/body_parts_process/bpro_target") }}', data,  function(result, status, xhr){
			if(result.status){
				fillTable();
