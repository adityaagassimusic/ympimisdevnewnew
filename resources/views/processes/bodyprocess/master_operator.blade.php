...
<script>
	...
	function fillList(){
		...
		$.get('{{ url("fetch/body_parts_process/operator") }}',data, function(result, status, xhr){
			if(result.status){
	...
	function update() {
		if (confirm('Apakah Anda yakin?')) {
			...
			$.post('{{ url("update/body_parts_process/operator") }}',data, function(result, status, xhr){
				if(result.status){
	...
	function add() {
		if (confirm('Apakah Anda yakin?')) {
			...
			$.post('{{ url("input/body_parts_process/operator") }}',data, function(result, status, xhr){
				if(result.status){
