...
<section class="content-header">
  ...
  <ol class="breadcrumb">
      <a href="{{ url("canteen/purchase_item/create_category")}}" class="btn btn-md bg-blue" target="_blank" style="color:white">
...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header" style="margin-top: 10px;text-align: center">
      <h2 class="box-title"><b>Food Item</b></h2>
    </div>  
    <form role="form">
      <div class="box-body">
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" class="form-control" id="item_code" placeholder="Kode Item">
          </div>
        </div>
        
        <div class="row" style="margin-top: 10px">
          <label class="col-sm-2 col-md-offset-1">Deskripsi<span class="text-red">*</span></label>
          <div class="col-sm-6" align="left">
  ...
  <script>
    ...
    $("#form_submit").click( function() {
      ...
      $.post('{{ url("canteen/purchase_item/create_post") }}', data, function(result, status, xhr){
        if(result.status == true){    
          $("#loading").hide();
          openSuccessGritter("Success","Berhasil Dibuat");
          // setTimeout(function(){ window.location = "{{ url('canteen/purchase_item') }}" }, 2000); 

          setTimeout(function(){  window.location = "{{url('canteen/purchase_item/update')}}/"+result.id; }, 1000); 
        }
        else {
          $("#loading").hide();
