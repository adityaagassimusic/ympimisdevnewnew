						...
						<div class="col-md-8 col-md-offset-2">
							<div class="col-md-12">
								<div class="form-group pull-right">
									...
									<a href="{{ url('index/ga_control/mcu/report/attendance') }}" class="btn btn-danger">Clear</a>
		...
		<div class="col-xs-12">
			<div class="box box-solid">
				<div class="box-body" style="overflow-x: scroll;">
					<div class="col-xs-12">
						<div class="row">
							<table id="tableAttendance" class="table table-bordered table-striped table-hover" style="margin-bottom: 0;">
...
<script>
	...
	function fillList(){
		...
		$.get('{{ url("fetch/ga_control/mcu/report/attendance") }}',data, function(result, status, xhr){
			if(result.status){
				...
				$.each(result.report, function(key, value) {
					...
					tableData += '<td>'+ value.flow_name+'</td>';
					tableData += '<td>'+ value.attendance_date+'</td>';
					tableData += '</tr>';
					index++;
				});
				$('#bodyTableAttendance').append(tableData);
