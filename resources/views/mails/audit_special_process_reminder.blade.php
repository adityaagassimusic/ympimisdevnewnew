...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 17px;">REMINIDER AUDIT PROSES KHUSUS<br>特殊工程の監査リマインダー</span><br>
			@else
			<span style="font-weight: bold; color: purple; font-size: 17px;">INFORMASI AUDIT PROSES KHUSUS BULAN INI<br>特殊工程の監査リマインダー</span><br>
			@endif
				...
				<table style="border:1px solid black; border-collapse: collapse;">
					...
					<tbody align="center">
						...
						<tr>
							...
							<td style="border:1px solid black; font-size: 15px; width: 20%; height: 20;text-align: left;">
							{{$data[0]['datas'][$i]->schedule_status}}
							</td>
							<td style="border:1px solid black; font-size: 15px; width: 20%; height: 20;text-align: center;">
								<a style="text-decoration: none;color: blue;" href="10.109.52.4/mirai/public/audit/qa/special_process/{{$data[0]['datas'][$i]->id}}">Lakukan Audit</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
