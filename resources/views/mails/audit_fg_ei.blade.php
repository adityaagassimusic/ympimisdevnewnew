...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">Temuan Audit FG / KD (梱包監査)</span><br>
		...
		<center>
				<table style="border:1px solid black; border-collapse: collapse;" width="80%">
					<thead style="text-align: center;">
						...
						<tr>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white;text-align: left;padding-left:10px;">Qty Lot</th>
							<td style="border:1px solid black;text-align: left;padding-left:10px;">
								{{$data->qty_lot}}
							</td>
						</tr>
						<tr>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white;text-align: left;padding-left:10px;">Qty Check</th>
							<td style="border:1px solid black;text-align: left;padding-left:10px;">
								{{$data->qty_check}}
							</td>
						</tr>
						...
						<tr>
							...
							<td style="border:1px solid black;text-align: left;">
								...
								Emp : <?php echo explode('_', $data->ng_detail)[6] ?> - <?php echo explode('_', $data->ng_detail)[7] ?>
								@endif
							</td>
						</tr>
						<tr>
