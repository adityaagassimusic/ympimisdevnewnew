...
<body>
	...
	<div>
		<center>
			...
			<p style="font-size: 18px;">Audit Label Safety Mesin<br>{{ $leader }} ({{ strtoupper($department_name) }})</p>
			...
			<table style="border:1px solid black; border-collapse: collapse;" width="80%">
				<thead style="background-color: rgb(126,86,134);">
					<tr>
						...
						<th style="width: 2%; border:1px solid black;">Nama Mesin</th>
				...
				<tbody>
					...
					<tr>
						...
						<td style="border:1px solid black; text-align: center;">{{$col->nama_mesin}}</td>
			...
			<a href="{{ url('index/labeling/print_labeling_email/'.$activity_list_id.'/'.$month) }}">See Daily Check FG Data / Approval Data</a>
		</center>
	</div>
</body>
</html>