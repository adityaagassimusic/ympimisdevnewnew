...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">CAR Audit QA Recorder Assembly</span><br>
				...
				<table style="border:1px solid black; border-collapse: collapse;" width="60%">
					<tbody>
						...
						<tr>
							...
							<td style="border:1px solid black;">{{$data['data_email_rc']->product}} - {{$data['data_email_rc']->part_name}}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border:1px solid black;">
								{{$data['data_email_rc']->pic_injection}}
							</td>
						</tr>
						<tr>
							<td style="border:1px solid black;font-weight: bold;background-color: #d4e157;">
						...
						<tr>
							...
							<td style="border:1px solid black;">
								<img style="width: 150px" src="data:image/png;base64,{{base64_encode(file_get_contents('http://10.109.52.4/mirai/public/data_file/recorder/qa_audit/'.$data['data_email_rc']->image))}}" alt="">
							</td>
						</tr>
					</tbody>
				</table>
	...
	<div>
		<center>
				...
				<!-- <a class="button" href="{{url('approve/recorder/qa_audit/assy/'.$data['remark'].'/'.$data['data_email_rc']->id)}}" style="font-weight:bold;font-size:20px">Approve</a> -->
				<a class="button_blue" href="{{url('print/recorder/qa_audit/assy/'.$data['data_email_rc']->id)}}" style="font-weight:bold;font-size:20px;">Hasil Training & Konseling</a>
				<br>
				<br>
				<p>
					<b>Thanks & Regards,</b>
