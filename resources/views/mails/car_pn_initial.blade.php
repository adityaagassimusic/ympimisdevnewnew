...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">CAR Audit QA Pianica Initial</span><br>
				...
				<table style="border:1px solid black; border-collapse: collapse;" width="60%">
					<tbody>
						...
						<tr>
							...
							<td style="border:1px solid black;">{{$data['data_email'][0]->product}}</td>
						</tr>
						<tr>
							...
							<td style="border:1px solid black;">
								{{$data['data_email'][0]->auditor_id}} - {{$data['data_email'][0]->auditor_name}}
							</td>
						</tr>
						<tr>
							<td style="border:1px solid black;font-weight: bold;background-color: #d4e157;">
						...
						<tr>
							...
							<td style="border:1px solid black;">
								<img style="width: 150px" src="data:image/png;base64,{{base64_encode(file_get_contents('http://10.109.52.4/mirai/public/data_file/pianica/qa_audit/'.$data['data_email'][0]->image))}}" alt="">
							</td>
						</tr>
					</tbody>
				</table>
	...
	<br>
	<?php $data_id = [];
	for ($i=0; $i < count($data['data_email']); $i++) { 
		array_push($data_id, $data['data_email'][$i]->id);
	} ?>
	<div>
		<center>
				<span style="font-weight: bold; background-color: orange;">&#8650; <i>Click Here For</i> &#8650;</span><br>
				<!-- <a class="button" href="{{url('approve/recorder/qa_audit/assy/'.$data['remark'].'/'.$data['data_email'][0]->id)}}" style="font-weight:bold;font-size:20px">Approve</a> -->
				<a class="button_blue" href="{{url('print/pn/qa_audit/initial/'.join(',',$data_id))}}" style="font-weight:bold;font-size:20px;">Hasil Training & Konseling</a>
				<br>
				<br>
				<p>
					<b>Thanks & Regards,</b>
