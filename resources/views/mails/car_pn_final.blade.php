...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">CAR Audit QA Pianica Final</span><br>
	...
	<div>
		<center>
				...
				<a class="button_blue" href="{{url('print/pn/qa_audit/final/'.join(',',$data_id))}}" style="font-weight:bold;font-size:20px;">Hasil Training & Konseling</a>
				<br>
				<br>
				<p>
					<b>Thanks & Regards,</b>
