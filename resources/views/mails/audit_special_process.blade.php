...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">Temuan Audit Proses Khusus (品証 特殊工程の監査)</span><br>
	...
	<div>
		<center>
				...
				<span style="font-weight: bold; background-color: orange;">&#8650; <i>Click Here For</i> &#8650;</span><br>
					<a href="http://10.109.52.4/mirai/public/handling/qa/special_process/{{$data->schedule_id}}">Input Penanganan</a><br>
					<br>
