...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">AUDIT NG JELAS REMINDER<br>PERIODE {{strtoupper($data['periode'])}}</span><br>
	...
	<div>
		<center>
				<table style="border:1px solid black; border-collapse: collapse;" width="80%">
					<thead style="text-align: center;">
						<tr>
							...
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white">Judul Claim</th>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white">Lokasi</th>
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white">Produk</th>
						</tr>
					</thead>
				...
				<span style="font-weight: bold; background-color: orange;">&#8650; <i>Click Here For</i> &#8650;</span><br><br>
					<a class="button" href="http://10.109.52.4/mirai/public/index/index/audit_ng_jelas">Lakukan Audit</a>
				<br>
				<br>
				<p>
					<b>Thanks & Regards,</b>
