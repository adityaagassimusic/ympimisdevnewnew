...
<body>
	<div>
		<center>
			...
			<span style="font-size: 18px;font-weight: bold;color: red">Pemberitahuan Surat Izin Keluar Shift 2 / Shift 3</span><br>
			<span style="font-size: 18px;color: red">Email ini adalah pemberitahuan bahwa ada karyawan yang keluar perusahaan pada Shift 2  / Shift 3.<br>Anda tidak perlu Approve Email berikut.</span>
			<br>
