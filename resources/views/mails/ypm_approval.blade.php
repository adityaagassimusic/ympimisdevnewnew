...
<body>
	<div>
		<center>
			...
			<br>
			<p style="font-size: 18px;font-weight: bold;color: green">YPM Contest Telah Disetujui Sepenuhnya.</p>
			@endif
			<p>
		...
		<center>
			...
			<div style="width: 80%">
				<br>
					...
					(下をクリックしてください)<br>
					<a style="background-color: green; width: 50px;text-decoration: none;color: white;font-size:20px;" href="{{ url('approval/standardization/ypm/'.$data['periode'].'/judges/'.$data['employee_id']) }}">&nbsp;&nbsp;&nbsp; Approve <small>(承認)</small> &nbsp;&nbsp;&nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a style="background-color: red; width: 50px;text-decoration: none;color: white;font-size:20px;margin-left: 50px" href="{{ url('reject/standardization/ypm/'.$data['periode'].'/judges/'.$data['employee_id']) }}">&nbsp;&nbsp;&nbsp; Reject <small>(却下)</small> &nbsp;&nbsp;&nbsp;</a>
					@endif
					<br>
					<br>
					<!-- <br>
