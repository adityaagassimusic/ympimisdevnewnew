...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">Reminder Cek Fisik</span><br>
	...
	<div>
		<center>
				...
				<span style="font-weight: bold; background-color: orange;">&#8650; <i>Click Here For</i> &#8650;</span><br>
					<a href="http://10.109.52.4/mirai/public/index/ga_control/mcu/monitoring/physical">Monitoring</a>
				<br>
				<!-- <br>
				<p>
					<b>Thanks & Regards,</b>
