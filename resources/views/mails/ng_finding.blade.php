			...
			<table style="border:1px solid black; border-collapse: collapse;" width="80%">
				<thead style="background-color: rgb(126,86,134);">
					<tr>
						...
						<th style="width: 2%; border:1px solid black;">Material Number</th>
						<th style="width: 2%; border:1px solid black;">Material Desc</th>
						<th style="width: 2%; border:1px solid black;">Quantity</th>
						<th style="width: 2%; border:1px solid black;">Finder</th>
						<th style="width: 2%; border:1px solid black;">Defect</th>
					</tr>
				</thead>
				<tbody>
					<?php $i = 1; ?>
					...
					<tr>
						...
						<td style="border:1px solid black; text-align: center;">{{$col->material_description}}</td>
						<td style="border:1px solid black; text-align: center;">{{$col->quantity}}</td>
						<td style="border:1px solid black; text-align: center;">{{$col->finder}}</td>
						<td style="border:1px solid black; text-align: center;">{{$col->defect}}</td>
					</tr>
					<?php $i++; ?>
					@endforeach
				</tbody>
