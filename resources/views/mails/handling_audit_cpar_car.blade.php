...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 17px;">REMINDER PENANGANAN AUDIT CPAR & CAR QA<br>品証 是正予防策・是正策監視 監査</span><br>
		...
		<center>
				...
				<table style="border:1px solid black; border-collapse: collapse;">
					<thead style="background-color: rgb(126,86,134);color: white">
						<tr>
							...
							<th style="font-size: 15px;border:1px solid black;">Audit Title</th>
					...
					<tbody align="center">
						...
						<tr>
							...
							<td style="border:1px solid black; font-size: 15px; width: 3%; height: 20;text-align: left;">{{$data[$i]->audit_title}}</td>
							...
							<td style="border:1px solid black; font-size: 15px; width: 3%; height: 20;text-align: center;">
								<a style="text-decoration: none;color: blue;" href="http://10.109.52.4/mirai/public/index/qa/cpar_car/handling/{{$data[$i]->schedule_id}}">Input Penanganan</a>
							</td>
						</tr>
						<?php $index++; ?>
						<?php } ?>
			...
			<div style="width: 80%">
				<br>
					...
					<br>
					<a style="width: 50px;text-decoration: none;font-size:16px;" href="http://10.109.52.4/mirai/public/index/qa/cpar_car">&nbsp;&nbsp;&nbsp; Monitoring <small>監視</small> &nbsp;&nbsp;&nbsp;</a>
				<br>
				<br>
			</div>
		</center>
