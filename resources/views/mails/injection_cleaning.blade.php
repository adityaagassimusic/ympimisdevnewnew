...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">INJECTION CLEANING NOT DONE</span><br>
	...
	<div>
		<center>
				<table style="border:1px solid black; border-collapse: collapse;" width="50%">
					<thead style="text-align: center;">
						<tr>
							...
							<th style="border:1px solid black;font-weight: bold;background-color: rgb(126,86,134);color: white">Equipment</th>
						</tr>
					</thead>
					<tbody style="text-align: center;">
						<?php for ($i=0; $i < count($data['detail']); $i++) {  ?>
						<tr>
				...
				<span style="font-weight: bold; background-color: orange;">&#8650; <i>Click Here For</i> &#8650;</span><br>
					<a class="button" href="http://10.109.52.4/mirai/public/index/injection/cleaning/monitoring">Monitoring</a>
				<br>
				<br>
				<p>
					<b>Thanks & Regards,</b>
