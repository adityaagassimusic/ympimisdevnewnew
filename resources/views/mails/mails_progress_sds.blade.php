...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: purple; font-size: 24px;">{{$data['title']}}</span><br><br>
			<table style="border-collapse: collapse; width: 50%">
				<thead>
					...
					<tr align="center"> 
						...
						<td style="border:1px solid black; font-size: 13px; width: 15%; height: 20;">Document ID</td>
						...
						<td style="border:1px solid black; font-size: 13px; width: 25%; height: 20;">Valid From</td>
						<td style="border:1px solid black; font-size: 13px; width: 25%; height: 20;">Valid To</td>
					</tr>
				</thead>
			...
			<a style="width: 50px;text-decoration: underline; color: blue;" href="{{ url('index/chemical/safety_data_sheet') }}">SDS Monitoring</a>
		</center>
	</div>
</body>
</html>