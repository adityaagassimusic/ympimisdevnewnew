  ...
  function drawChart() {
    ...
    $.get('{{ url("fetch/report/overtime_report_control") }}', data, function(result) {
      ...
      $.each(result.ot_detail, function(key, value) {
        ...
        $.each(result.cc, function(key2, value2) {
          if (value.cost_center.toUpperCase() == value2.cost_center_name) {
      ...
      $.each(result.cc, function(key, value) {
        ...
        if(xCategories2.indexOf(value.cost_center_department) === -1){
          xCategories2[xCategories2.length] = value.cost_center_department.toUpperCase();
        }
      ...
      Highcharts.chart('over_control', {
        ...
        title: {
          text: 'Overtime Control - Budget<br><center style="font-size: 24px;">'+ result.dt +'</center>',
          style: {
            fontSize: '30px',
            fontWeight: 'bold'
          }
