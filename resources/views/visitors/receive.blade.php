...
<div class="row">
	<div class="col-xs-12">
		<div class="box box-solid collapsed-box">
			<center style="background-color: #41b012;color: white"><h3 class="box-title" style="font-weight: bold;padding: 10px">Visitor Leave</h3></center>
			<div class="box-header with-border">
				<center><a href="{{url('visitor_index')}}" class="btn btn-danger pull-left btn-sm"><i class="fa fa-arrow-circle-left"></i> Cancel</a><h3 class="box-title" style="font-weight: bold;">Tekan Tombol di Kanan&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></h3></center>
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						<div class="modal-header" style="background-color: lightskyblue">
							...
							<h4 class="modal-title">Visitor Data</h4>
							<div id="header">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-danger pull-left" data-dismiss="modal"><b>Cancel</b></button>
							<button type="button" class="btn btn-success" onclick="reloadtable();"><b>Save Tag</b></button>
						</div>
					</div>
				</div>
			</div>
