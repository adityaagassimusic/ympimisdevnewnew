...
<script>
			...
			if(xhr.status == 200){
				if(result.status){
					...
					Highcharts.chart('container', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					for(i = 0; i < result.ng_line_1.length; i++){
						...
						biri.push({y:parseInt(result.ng_line_1[i].biri),key:result.ng_line_1[i].date});
						oktaf.push({y:parseInt(result.ng_line_1[i].oktaf),key:result.ng_line_1[i].date});
						t_tinggi.push({y:parseInt(result.ng_line_1[i].t_tinggi),key:result.ng_line_1[i].date});
						t_rendah.push({y:parseInt(result.ng_line_1[i].t_rendah),key:result.ng_line_1[i].date});
						total_ng.push(parseInt(result.ng_line_1[i].biri)+parseInt(result.ng_line_1[i].oktaf)+parseInt(result.ng_line_1[i].t_tinggi)+parseInt(result.ng_line_1[i].t_rendah));
					}
					...
					Highcharts.chart('container1', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR LINE 1",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					for(i = 0; i < result.ng_line_2.length; i++){
						...
						biri.push({y:parseInt(result.ng_line_2[i].biri),key:result.ng_line_2[i].date});
						oktaf.push({y:parseInt(result.ng_line_2[i].oktaf),key:result.ng_line_2[i].date});
						t_tinggi.push({y:parseInt(result.ng_line_2[i].t_tinggi),key:result.ng_line_2[i].date});
						t_rendah.push({y:parseInt(result.ng_line_2[i].t_rendah),key:result.ng_line_2[i].date});
						total_ng.push(parseInt(result.ng_line_2[i].biri)+parseInt(result.ng_line_2[i].oktaf)+parseInt(result.ng_line_2[i].t_tinggi)+parseInt(result.ng_line_2[i].t_rendah));
					}
					...
					Highcharts.chart('container2', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR LINE 2",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					for(i = 0; i < result.ng_line_3.length; i++){
						...
						biri.push({y:parseInt(result.ng_line_3[i].biri),key:result.ng_line_3[i].date});
						oktaf.push({y:parseInt(result.ng_line_3[i].oktaf),key:result.ng_line_3[i].date});
						t_tinggi.push({y:parseInt(result.ng_line_3[i].t_tinggi),key:result.ng_line_3[i].date});
						t_rendah.push({y:parseInt(result.ng_line_3[i].t_rendah),key:result.ng_line_3[i].date});
						total_ng.push(parseInt(result.ng_line_3[i].biri)+parseInt(result.ng_line_3[i].oktaf)+parseInt(result.ng_line_3[i].t_tinggi)+parseInt(result.ng_line_3[i].t_rendah));
					}
					...
					Highcharts.chart('container3', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR LINE 3",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					for(i = 0; i < result.ng_line_4.length; i++){
						...
						biri.push({y:parseInt(result.ng_line_4[i].biri),key:result.ng_line_4[i].date});
						oktaf.push({y:parseInt(result.ng_line_4[i].oktaf),key:result.ng_line_4[i].date});
						t_tinggi.push({y:parseInt(result.ng_line_4[i].t_tinggi),key:result.ng_line_4[i].date});
						t_rendah.push({y:parseInt(result.ng_line_4[i].t_rendah),key:result.ng_line_4[i].date});
						total_ng.push(parseInt(result.ng_line_4[i].biri)+parseInt(result.ng_line_4[i].oktaf)+parseInt(result.ng_line_4[i].t_tinggi)+parseInt(result.ng_line_4[i].t_rendah));
					}
					...
					Highcharts.chart('container4', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR LINE 4",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					for(i = 0; i < result.ng_line_5.length; i++){
						...
						biri.push({y:parseInt(result.ng_line_5[i].biri),key:result.ng_line_5[i].date});
						oktaf.push({y:parseInt(result.ng_line_5[i].oktaf),key:result.ng_line_5[i].date});
						t_tinggi.push({y:parseInt(result.ng_line_5[i].t_tinggi),key:result.ng_line_5[i].date});
						t_rendah.push({y:parseInt(result.ng_line_5[i].t_rendah),key:result.ng_line_5[i].date});
						total_ng.push(parseInt(result.ng_line_5[i].biri)+parseInt(result.ng_line_5[i].oktaf)+parseInt(result.ng_line_5[i].t_tinggi)+parseInt(result.ng_line_5[i].t_rendah));
					}
					...
					Highcharts.chart('container5', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AKHIR LINE 5",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
	...
	function showHighlight(ng_name,date,line) {
		...
		$.get('{{ url("fetch/detailKensaAkhirDaily") }}', data, function(result, status, xhr) {
			if(result.status){
