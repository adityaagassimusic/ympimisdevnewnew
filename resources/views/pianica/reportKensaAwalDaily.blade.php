...
<script>
	...
	function fillTable() {
		...
		$.get('{{ url("fetch/getReportKensaAwalDaily") }}', data, function(result, status, xhr) {
			if(xhr.status == 200){
				if(result.status){
					...
					Highcharts.chart('container', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container1', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL LINE 1",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container2', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL LINE 2",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container3', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL LINE 3",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container4', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL LINE 4",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container5', {
						...
						title: {
							text: "TREND & TRACEABILITY NG KENSA AWAL LINE 5",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
