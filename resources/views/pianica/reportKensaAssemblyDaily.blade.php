...
<script>
	...
	function fillTable() {
		...
		$.get('{{ url("fetch/getReportAssemblyDaily") }}', data, function(result, status, xhr) {
			if(xhr.status == 200){
				if(result.status){
					...
					Highcharts.chart('container', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container1', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY LINE 1",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container2', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY LINE 2",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container3', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY LINE 3",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container4', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY LINE 4",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
					...
					Highcharts.chart('container5', {
						...
						title: {
							text: "TREND & TRACEABILITY NG ASSEMBLY LINE 5",
							style: {
								fontSize: '30px',
								fontWeight: 'bold'
							}
	...
	function showHighlight(ng_loc,date,line) {
		...
		if (ng_loc == 'Cover Lower') {
			ng_loc = 'PN_Assembly_Cover Lower';
		}
		if (ng_loc == 'Cover R/L') {
			ng_loc = 'PN_Assembly_Cover R/L';
		}
		if (ng_loc == 'Frame Assy') {
			ng_loc = 'PN_Assembly_Frame Assy';
		}
		if (ng_loc == 'Handle') {
			ng_loc = 'PN_Assembly_Handle';
		}
		if (ng_loc == 'Button') {
			ng_loc = 'PN_Assembly_Button';
		}
		var data = {
			ng_loc:ng_loc,
			date:date,
		...
		$.get('{{ url("fetch/detailKensaAssemblyDaily") }}', data, function(result, status, xhr) {
			if(result.status){
