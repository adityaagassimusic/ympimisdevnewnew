...
<section class="content-header">
  <h1>
     {{ $page }}
    <span class="text-purple"> 最終検査リポート</span>
...
<script>
  ...
  function ngTotal() {
    ...
    $.get('{{ url("index/getKensaAkhirALL") }}',data, function(result, status, xhr){
              console.log(status);
              console.log(result);
              console.log(xhr);
              if(xhr.status == 200){
    ...
    Highcharts.chart('container2', {
        ...
        text: 'Total 3 Month Before '+tgl
              ...
              series: [{
                ...
                data: [{
                  name: 'Biri',
                  y: result.nglas[0].total
                  // y: 1                 
                },
                {
                  name: 'Oktaf',
                  y: result.nglas[1].total 
                  // y: 1                 
                },
                {
                  name: 'T. Rendah',
                  y: result.nglas[2].total 
                  // y: 1                 
                }
                ,
                {
                  name: 'T. Tinggi',
                  y: result.nglas[3].total 
                  // y: 1                 
                }]
              }]
            });
