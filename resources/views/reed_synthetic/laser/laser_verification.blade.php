...
<section class="content" style="padding-top: 0;">
	...
	<div class="row">
		<input type="hidden" id="location" value="laser">
		<input type="hidden" id="proses" value="laser">
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header no-padding">
				<h4 style="background-color: #E57373; text-align: center; font-weight: bold; padding-top: 3%; padding-bottom: 3%;" class="modal-title">
...
<script>
	...
	function startInj(){
		...
		if(confirm("Apakah anda yakin memulai proses laser?")){
	...
	function finishInj(){
		...
		if(confirm("Apakah anda yakin mengakhiri proses laser?")){
