...
<section class="content" style="padding-top: 0;">
	...
	<div class="row">
		<input type="hidden" id="location" value="annealing">
		<input type="hidden" id="proses" value="annealing">
...
<script>
	...
	function startInj(){
		...
		if(confirm("Apakah anda yakin memulai proses annealing?")){
	...
	function finishInj(){
		...
		if(confirm("Apakah anda yakin mengakhiri proses annealing?")){
