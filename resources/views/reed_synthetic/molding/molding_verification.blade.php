	...
	<div class="row">
		...
		<div class="col-xs-12" id="picking">	
			...
			<div class="col-xs-6 col-xs-offset-3">
				<button id="finishSetup" onclick="finishSetup()" class="btn btn-success" style="font-weight: bold; font-size: 3vw; width: 100%;"><i class="fa fa-check-square-o"></i>&nbsp;&nbsp;&nbsp;PRE APPROVAL</button>
			</div>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header no-padding">
				<h4 style="background-color: #FFD54F; text-align: center; font-weight: bold; padding-top: 3%; padding-bottom: 3%;" class="modal-title">
					SETUP MOLDING VERIFICATION
				</h4>
			</div>
...
<script>
	...
	function finishSetup(){
		...
		var employee_id = $('#employee_id').val();
		var order_id = $('#order_id').val();
		window.open('{{ url("index/reed/approval/")}}'+'/'+location+'/'+order_id+'/'+employee_id, '_blank');
	}
