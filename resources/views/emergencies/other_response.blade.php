				...
				<table class="table table-bordered table-stripped">
					<thead style="background-color: rgb(112, 112, 112); color: rgb(255,255,2555); font-size: 20px;">
						<tr>
							...
							<th style='background-color: rgb(255,204,255); color: black' width="15%">Ya</th>
							<th style='background-color: rgb(204,255,255); color: black' width="15%">Tidak</th>
							<th width="15%">Tidak Respon</th>
						</tr>
					</thead>
					<tbody id="tabelbody">
					</tbody>
		...
		Highcharts.chart('pie_chart1', {
			...
			plotOptions: {
				pie: {
					...
					dataLabels: {
						enabled: true,
						format: '<b>{point.name}<br/>{point.percentage:.2f}%</b>',
						distance: -50,
						color: 'black',
						style:{
							fontSize:'16px',
