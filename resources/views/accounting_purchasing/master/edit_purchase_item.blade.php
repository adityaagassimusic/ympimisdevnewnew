...
<section class="content">
    ...
    <form role="form" id="editfrom">
      <div class="box-body">
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" class="form-control" id="item_code" name="item_code" placeholder="Kode Item" value="{{$item->kode_item}}">
          </div>
        </div>
        ...
        <!-- <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="item_spec" class="form-control" placeholder="Spesifikasi" value="{{$item->spesifikasi}}">
          </div>
        </div> -->
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <select class="form-control select2" id="item_currency"  name="item_currency" data-placeholder='Currency' style="width: 100">
              <option value="">&nbsp;</option>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <div class="input-group">
                <input type="text" id="item_leadtime" name="item_leadtime" class="form-control" placeholder="Leadtime" value="{{$item->leadtime}}">
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="item_lot" name="item_lot" class="form-control" placeholder="Lot" value="{{$item->lot}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="item_moq" name="item_moq" class="form-control" placeholder="MOQ" value="{{$item->moq}}">
          </div>
        </div>

       <!--  <div class="row" style="margin-top: 10px">
          <label class="col-sm-2 col-md-offset-1">Old Foto</label>
          <div class="col-sm-6" align="left">
          <img src="{{url('images/purchase_item/'.$item->img_kode_item)}}" style="width: 300px;">
          </div>
        </div> -->
       ...
       <!--  <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="file" id="item_file_edit" name="item_file_edit">
          </div>
        </div> -->
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-offset-5" style="padding-top: 10px">
            ...
            <div class="btn-group">
              <input type="hidden" id="id_edit" name="id_edit" value="{{$item->id}}">
  ...
  <script>
    ...
    //   $.post('{{ url("index/purchase_item/edit_post") }}', data, function(result, status, xhr){
    ...
    $("form#editfrom").submit(function(e){
      ...
      $.ajax({
        url: '{{ url("index/purchase_item/edit_post") }}',
        type: 'POST',
