			...
			<table class="table table-bordered" id="store_table">
				<thead>
					<tr>
						...
						<th style="width:15%; background-color: rgb(220,220,220); text-align: center; color: black; padding:0;font-size: 25px;" colspan="9" id='po_title'>Nomor PO House Hold</th>
					</tr>
					<tr>
...
<script>
	...
	function fetchTable(){
		...
		var table = $('#itemtable').DataTable({
			...
			"ajax": {
				"type" : "get",
				"url" : "{{ url('fetch/ga/outstanding_kedatangan_ga') }}",
				"data" : data
			},
			"columns": [
			{ "data": "no_po"},
