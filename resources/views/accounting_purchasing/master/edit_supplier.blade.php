...
<section class="content-header">
  <h1>
    Update {{ $page }}
    <small>Submit Supplier Data Here</small>
  </h1>
  <ol class="breadcrumb">
...
<section class="content">
    ...
    <form role="form">
      <div class="box-body">
         ...
         <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <select class="form-control select2" id="supplier_currency"  name="supplier_currency" data-placeholder='Currency' style="width: 100">
              <option value="">&nbsp;</option>
              @if($supplier->supplier_currency == "USD")
              <option value="USD" selected="">USD</option>
              <option value="IDR">IDR</option>
              <option value="JPY">JPY</option>
              @elseif($supplier->supplier_currency == "IDR")
              <option value="USD">USD</option>
              <option value="IDR" selected="">IDR</option>
              <option value="JPY">JPY</option>
              @elseif($supplier->supplier_currency == "JPY")
              <option value="USD">USD</option>
              <option value="IDR">IDR</option>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" class="form-control" id="supplier_address" placeholder="Address" value="{{$supplier->supplier_address}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="supplier_city" name="supplier_city" class="form-control" placeholder="City" value="{{$supplier->supplier_city}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="supplier_phone" class="form-control" placeholder="Phone Number" value="{{$supplier->supplier_phone}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="supplier_fax" class="form-control" placeholder="Faximile" value="{{$supplier->supplier_fax}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="contact_name" class="form-control" placeholder="Contact Person" value="{{$supplier->contact_name}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="supplier_npwp" class="form-control" placeholder="NPWP" value="{{$supplier->supplier_npwp}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="supplier_duration" class="form-control" placeholder="Duration" value="{{$supplier->supplier_duration}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="position" class="form-control" placeholder="Position" value="{{$supplier->position}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <select class="form-control select2" id="supplier_status" data-placeholder='Status' style="width: 100%">
              <option value="">&nbsp;</option>
              @if($supplier->supplier_status == "PKP")
              <option value="PKP" selected="">PKP</option>
              <option value="Non PKP">Non PKP</option>
              <option value="Import">Import</option>
              @elseif($supplier->supplier_status == "Non PKP")
              <option value="PKP">PKP</option>
              <option value="Non PKP" selected="">Non PKP</option>
              <option value="Import">Import</option>
              @elseif($supplier->supplier_status == "Import")
              <option value="PKP">PKP</option>
              <option value="Non PKP">Non PKP</option>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <select class="form-control select2" id="supplier_status_fix" data-placeholder='Kategori Vendor' style="width: 100%">
              <option value="">&nbsp;</option>
              @if($supplier->supplier_status_fix == "Lokal")
              <option value="Lokal" selected>Lokal</option>
              <option value="Import">Import</option>
              @elseif($supplier->supplier_status_fix == "Import")
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <select class="form-control select2" id="supplier_pch_code" data-placeholder='Kode Purchasing Vendor' style="width: 100%">
              <option value="">&nbsp;</option>
              @if($supplier->supplier_pch == "Equipment")
              ...
              @elseif($supplier->supplier_pch == "Material")
              <option value="Equipment">Equipment</option>
              <option value="Material" selected>Material</option>
              <option value="Trucking">Trucking</option>
              <option value="Handling Export & Import">Handling Export & Import</option>
              @elseif($supplier->supplier_pch == "Trucking")
              <option value="Equipment">Equipment</option>
              <option value="Material">Material</option>
              <option value="Trucking" selected>Trucking</option>
              <option value="Handling Export & Import">Handling Export & Import</option>
              @elseif($supplier->supplier_pch == "Handling Export & Import")
              <option value="Equipment">Equipment</option>
              <option value="Material">Material</option>
              <option value="Trucking">Trucking</option>
              <option value="Handling Export & Import" selected>Handling Export & Import</option>
              @else
              <option value="Equipment">Equipment</option>
              <option value="Material">Material</option>
              <option value="Trucking">Trucking</option>
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-offset-5" style="padding-top: 10px">
            ...
            <div class="btn-group">
              <input type="hidden" id="id_edit" value="{{$supplier->id}}">
  ...
  <script>
    ...
    $("#form_submit").click( function() {
      ...
      $.post('{{ url("index/supplier/update") }}', data, function(result, status, xhr){
        if(result.status == true){    
          $("#loading").hide();
          openSuccessGritter("Success","Berhasil Dibuat");
          setTimeout(function(){ window.location = "{{ url('index/supplier') }}" }, 2000); 
        }
        else {
          $("#loading").hide();
