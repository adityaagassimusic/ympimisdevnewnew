...
<section class="content-header">
	<h1>
		Purchasing New Item List <span class="text-purple">{{ $title_jp }}</span>
	</h1>
	<ol class="breadcrumb">
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<div class="input-group date">
									...
									<input type="text" class="form-control pull-right datepicker" id="month" name="month" placeholder="Bulan">
								</div>
							</div>
						</div>
  ...
  function openSuccessGritter(title, message){
	...
	function fetchTable(){
		...
		var table = $('#itemtable').DataTable({
			...
			"ajax": {
				"type" : "get",
				"url" : "{{ url("fetch/purchase_new_item") }}",
				"data" : data
			},
			"columns": [
			{ "data": "kode_item"},
