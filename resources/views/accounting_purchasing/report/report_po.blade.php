					...
					<tr>
						<td colspan="3" style="width: 40%">
							...
							@elseif($po[0]->buyer_id == "PI1506001")
								...
								<span style="position: absolute;left: 5px;width: 75px;font-size: 10px;font-weight: bold;top: 90px;font-family: arial-narrow"><?= date('d-M-y', strtotime($po[0]->tgl_po)) ?></span>
							@else
								<?= $po[0]->buyer_name ?>
							@endif
						</td>
	...
	<main>
		<table style="width: 100%; font-family: TimesNewRoman; border-collapse: collapse; " id="isi">
			...
			<tbody>
				...
				<tr>
					<td colspan="5">
					<td colspan="2" style="font-weight: bold;font-size: 12px;text-align: right;padding-right: 5px">VAT 
						<?php 
