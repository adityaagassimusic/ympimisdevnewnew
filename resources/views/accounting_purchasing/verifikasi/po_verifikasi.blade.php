...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-body">
      ...
      || (($user == $po->authorized3 || str_contains(Auth::user()->role_code, 'MIS')) && $po->approval_authorized3 == null && $po->posisi == "dgm_pch")
  ...
  <div class="modal modal-danger fade" id="notapproved" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form role="form" method="post" action="{{url('purchase_order/notapprove/'.$po->id)}}">
