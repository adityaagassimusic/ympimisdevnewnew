...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-body">
      ...
      @if(
      (($user == $pr->manager || str_contains(Auth::user()->role_code, 'MIS')) && $pr->approvalm == null && $pr->posisi == "manager") 
      || (($user == $pr->gm || str_contains(Auth::user()->role_code, 'MIS')) && $pr->approvalgm == null && $pr->posisi == "gm"))

      <form role="form" id="myForm" method="post" action="{{url('canteen/purchase_requisition/approval/'.$pr->id)}}" enctype="multipart/form-data">
  ...
  <div class="modal modal-danger fade" id="notapproved" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form role="form" method="post" action="{{url('canteen/purchase_requisition/notapprove/'.$pr->id)}}">
