...
<section class="content-header">
	<h1>
		Receive Material YMES <span class="text-purple">{{ $title_jp }}</span>
	</h1>
	<ol class="breadcrumb">
		<li>
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box no-border">
						<div class="box-body" style="padding-top: 0;overflow-x: scroll;">
							<table id="ReceiveTable" class="table table-bordered table-striped table-hover">
								<thead style="background-color: rgba(126,86,134,.7);">
									<tr>
										<th style="width:5%;">Material Document</th>
										<th style="width:5%;">Reference</th>
										<th style="width:5%;">Document Header Text</th>
										<th style="width:3%;">Doc Date</th>
										<th style="width:3%;">Posting Date</th>
										<th style="width:3%;">Entry Date</th>	
										<th style="width:2%;">MvT</th>
										<th style="width:3%;">Vendor Code</th>
										<th style="width:6%;">Vendor Name</th>
										<th style="width:3%;">Material</th>
										<th style="width:6%;">Material Name</th>
										<th style="width:3%;">Sloc</th>
										<th style="width:5%;">SJ/Inv</th>
										<th style="width:3%;">Loc Amount</th>
										<th style="width:3%;">Loc Curr</th>
										<th style="width:3%;">Amount</th>
										<th style="width:3%;">Curr</th>
										<th style="width:3%;">Quantity</th>
										<th style="width:3%;">Bun</th>
										<th style="width:3%;">PO</th>
										<th style="width:3%;">Line PO</th>
										<th style="width:3%;">Pch Group</th>
										<!-- <th style="width:3%;">Standard Price</th> -->
									</tr>
								</thead>
								<tbody>
								</tbody>
...
<script>
	...
	function fetchTable(){
		...
		var table = $('#ReceiveTable').DataTable({
			...
			"ajax": {
				"type" : "get",
				"url" : "{{ url('fetch/billing/receive_material') }}",
				"data" : data
			},
			"columns": [
				{ "data": "mat_doc", "width":"8%"},
				{ "data": "ref_doc_no", "width":"8%"},
				{ "data": "doc_header_text", "width":"20%"},
				{ "data": "slip_date"},
				{ "data": "post_date"},
				{ "data": "sap_input_date"},
				{ "data": "sap_move_type"},
