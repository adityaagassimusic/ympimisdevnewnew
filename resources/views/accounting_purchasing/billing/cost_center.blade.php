		...
		$.get('{{ url("fetch/cost_center") }}', function(result, status, xhr){
			if(result.status){
				...
				$.each(result.cost_center, function(key, value){
					listTableBody += '<tr>';
                    listTableBody += '<td style="text-align:left">'+value.cost_center+'</td>';
                    listTableBody += '<td style="text-align:left">'+value.cost_center_name+'</td>';
                    listTableBody += '<td style="text-align:left">'+value.code+'</td>';
                    listTableBody += '<td style="text-align:left">'+value.remark+'</td>';
					listTableBody += '</tr>';
