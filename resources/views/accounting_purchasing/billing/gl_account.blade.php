	...
	function fetchTable(){
		...
		$.get('{{ url("fetch/gl_account") }}', function(result, status, xhr){
			if(result.status){
				...
				$.each(result.gl_account, function(key, value){
					listTableBody += '<tr>';
                    listTableBody += '<td style="text-align:center">'+value.gl_account+'</td>';
                    listTableBody += '<td style="text-align:center">'+value.gl_description+'</td>';
                    listTableBody += '<td style="text-align:center">'+value.acc_type+'</td>';
					listTableBody += '</tr>';
					count_all += 1;
				});
