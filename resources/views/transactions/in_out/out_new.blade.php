            ...
            <div class="col-md-8">
                <div class="col-md-6">
                    <div class="panel panel-default ">
                        <div class="panel-heading" style="background-color: #d9534f; color: #ffffff;">
                        ...
                        <div class="panel-body">
                            ...
                            <h3 id="header-type" style="color: #3f1817; font-weight: bold;"></h3>
            ...
            <div class="col-md-4">
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        ...
                        @if (in_array(strtoupper($remark), ['BPP-IN', 'BPP-OUT', 'WLD-IN', 'WLD-OUT', 'BFF-IN', 'BFF-OUT', 'PLT-IN', 'PLT-OUT']))
                            <div class="col-xs-4" style="padding: 10px 5px 10px 5px;">
                                <button class="btn btn-default" style="width: 100%; font-weight: bold;"
                        ...
                        {{-- <h4 style="font-weight: bold; color:#a94442; margin: 0px;">RESUME</h4>
                        <div class="table-responsive">
                        ...
                        <h4 style="font-weight: bold; color:#a94442; margin: 0px;">LIST</h4>
                        <div class="table-responsive">
