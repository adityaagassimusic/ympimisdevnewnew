  ...
  <header class="main-header" >
   ...
   <div class="content-wrapper" style="background-color: #ecf0f5; padding-top: 10px;">
    <section class="content">
     <form id ="importForm" name="importForm" method="post" action="{{ url('save/approval/comment') }}" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  function confirmReasons() {
    ...
    $.get('{{ url("save/approval/comment") }}',data, function(result, status, xhr){
      if(result.status){
        $("#loading").hide();
        $('#div_reason').hide();
