...
<body>
	<div>
		<center>
			...
			<span style="font-weight: bold; color: green; font-size: 24px;">New Checksheet Information</span>
		</center>
		<br>
		<div style="width: 50%; margin: auto;">
			...
			<table style="border:1px solid black; border-collapse: collapse; width: 100%;">
				<tbody>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Checksheet No.</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->id_checkSheet }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Carier</th>
						<td style="border:1px solid black;">{{ $data['carier'][$data['checksheet']->carier] }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Container No.</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->countainer_number }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Seal No.</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->seal_number }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Vehicle Reg No.</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->no_pol }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Destination</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->destination }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Invoice</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->invoice }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">DO Number</th>
						<td style="border:1px solid black;">{{ $data['checksheet']->do_number }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">Stuffing Date</th>
						<td style="border:1px solid black;">{{ date('l, d M Y', strtotime($data['checksheet']->Stuffing_date)) }}</td>
					</tr>
					<tr>
						<th style="border:1px solid black; background-color: #aee571;">On Or About</th>
