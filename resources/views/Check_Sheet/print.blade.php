    ...
    <div class="col-xs-15">
        ...
        <div class="col-xs-15"> 
            <table border="1" width="100%">
                <THEAD>
                    <th colspan="7" style="border: 1px solid">
                        <center>CONTAINER & CARGO CHECK SHEET</center>
                    </th>
                </THEAD>
                <tbody>
                    <tr>
            ...
            <table border="1" width="100%" >
                <thead>
                    ...
                    <tr id="cargo">
                        ...
                        <th colspan="2" style="border: 1px solid"><center>PACKAGE TYPE</center></th>
                        <th colspan="2" style="border: 1px solid"><center>QUANTITY</center></th>
                        <th style="border: 1px solid"><center>PACKAGE<br>OR BOX</center></th>
                ...
                <tbody id="isi">
                    ...
                    <TR id="cargo{{$nomor + 1}}">
                        ...
                        @endif
                        <TD style="border-right: 1px solid; border-left: 1px solid" width="3%"><center>{{$detail->package_set}}</center></TD>
                        ...
                        <TD style="border-right: 1px solid; border-left: 1px solid" align="center">{{$detail->box}}</TD>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th style="border-right: 1px solid; border-bottom: 1px solid; border-top: 1px solid" colspan="32" rowspan="2"></th>
                    </tr>
                    <tr>
    ...
    function myFunction2() {  
        ...
        for (var z = nomor; z <= count; z++) {
            ...
            for (i = 10; i < 40; i++) {
                ...
                var x = row.insertCell(i);
                var Cells = row.getElementsByTagName("td");
                if (s <= Cells[9].innerText) x.innerHTML = "&#10004;";
                x.style.width ="15pt";
                x.style.textAlign = "center";
                s++;
            }
