...
<section class="content-header">
	<h1>
		Digital Order & Control Stock Tools<small class="text-purple"></small>
	</h1>
</section>
@stop
@section('content')
<section class="content">
	<div class="row">
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url('tools/bom') }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: black;">Tools BOM Data</a>
		...
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url('tools/need_order') }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: green;">Tools Need Order</a>
		</div>
		<div class="col-xs-4" style="text-align: center;">
			...
			<a href="{{ url('tools/calculation') }}" class="btn btn-default btn-block" style="font-size: 24px; border-color: purple;">Tools Calculation</a>
