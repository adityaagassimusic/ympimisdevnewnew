...
<section class="content-header">
	<h1>
		Tools / Equipment List YMPI <span class="text-purple">{{ $title_jp }}</span>
	</h1>
	<ol class="breadcrumb">
		<li>
			<a href="{{ url("index/tools/create")}}" class="btn btn-md bg-purple" style="color:white"><i class="fa fa-plus"></i> Create New Tools</a>
		</li>
	</ol>
</section>
@stop
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								<select class="form-control select2" multiple="multiple" id='tools' data-placeholder="Select Tools" style="width: 100%;">
									<option></option>
									@foreach($tools as $tl)
									<option value="{{ $tl->tool }}">{{ $tl->tool }}</option>
									@endforeach
								</select>
							</div>
						</div>
							...
							<table id="toolTable" class="table table-bordered table-striped table-hover">
								<thead style="background-color: rgba(126,86,134,.7);">
									<tr>
										...
										<th style="width:5%;">Kanban Edar</th>
