...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header" style="margin-top: 10px;text-align: center">
      <h2 class="box-title"><b>Edit Data Tools</b></h2>
    </div>  
    <form role="form">
      <div class="box-body">
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" class="form-control" id="rack_code" placeholder="Kode Rak" value="{{$item->rack_code}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            ...
            <input type="text" id="item_desc" name="item_desc" class="form-control" placeholder="Deskripsi" value="{{$item->item_code}}" readonly="">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
              <input type="text" id="description" name="description" class="form-control" placeholder="Harga" readonly="" value="{{$item->description}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
              ...
              <input type="text" id="location" name="location" class="form-control" placeholder="Harga" readonly="" value="{{$item->location}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <!-- <select class="form-control select2" id="group" data-placeholder='Group' style="width: 100%">
             ...
             <input type="text" id="group" name="group" class="form-control" placeholder="Harga" readonly="" value="{{$item->group}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
           <!--  <select class="form-control select2" id="category" data-placeholder='Category' style="width: 100%">
            ...
            <input type="text" id="category" name="category" class="form-control" placeholder="Harga" readonly="" value="{{$item->category}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            ...
            <input type="text" id="remark" name="remark" class="form-control" placeholder="Remark" readonly="" value="{{$item->remark}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            ...
            <input type="text" id="remark" name="remark" class="form-control" placeholder="Remark" value="{{$item->moq}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="uom" name="uom" class="form-control" placeholder="Uom" value="{{$item->uom}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            ...
            <input type="text" id="lot_kanban" name="lot_kanban" class="form-control" placeholder="Lot Kanban" value="{{$item->lot_kanban}}">
          </div>
        </div>
        ...
        <div class="row" style="margin-top: 10px">
          ...
          <div class="col-sm-6" align="left">
            <input type="text" id="lifetime" name="lifetime" class="form-control" placeholder="Lifetime" value="{{$item->lifetime}}">
          </div>
        </div>

        <div class="row" style="margin-top: 10px">
          <label class="col-sm-2 col-md-offset-1">Safety Stock<span class="text-red">*</span></label>
          <div class="col-sm-6" align="left">
            <input type="text" id="safety_stock" name="safety_stock" class="form-control" placeholder="Safety Stock" value="{{$item->need_kanban}}">
          </div>
        </div>
