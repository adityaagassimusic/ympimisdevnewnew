...
<section class="content" style="padding-top: 0;">
	<div class="row">
		<div class="col-xs-12" style="margin-top: 0px;">
			...
			<div class="col-xs-2" style="padding-right: 0;">
					<div class="small-box" style="background: #32a852; height: 200px; margin-bottom: 5px;">
						<div class="inner" style="padding-bottom: 0px;">
							<h3 style="margin-bottom: 0px;font-size: 2vw;"><b>SUDAH INSTALL</b></h3>
					...
					<div class="small-box" style="background: #f44336; height: 200px; margin-bottom: 5px;">
						<div class="inner" style="padding-bottom: 0px;">
							<h3 style="margin-bottom: 0px;font-size: 2vw;"><b>BELUM INSTALL</b></h3>
			...
			<!-- <div class="col-xs-4" style="margin-top: 5px;padding-left: 0px">
				<div id="container2" style="width: 100%;height: 40vw;"></div> -->
				<!-- <div id="container2" style="width: 100%;"></div>
			</div> -->
		</div>
	</div>
...
<script>
	...
	function fillChart() {
		...
		$.get('{{ url("fetch/peduli_lindungi") }}',function(result, status, xhr) {
			if(xhr.status == 200){
				if(result.status){
					...
					$('#persen_sudah').text(((total_sudah/total_all)*100).toFixed(0)+'%');
					$('#persen_belum').text(((total_belum/total_all)*100).toFixed(0)+'%');
	...
	function ShowModal(dept,answer) {
		...
		$.get('{{ url("fetch/peduli_lindungi/detail") }}', data, function(result, status, xhr) {
			if(result.status){
