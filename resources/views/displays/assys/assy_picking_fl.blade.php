                ...
                <form method="GET" action="{{ url('index/display/sub_assy/' . $option) }}">
                    ...
                    <div class="col-xs-2">
                        <select class="form-control select2" id="order" onchange="changeOrder()" placeholder="Order by">
                            ...
                            <option value="1" <?php if ($_GET['order2'] != '') {
                                echo 'selected';
                            } ?>>Stock Room</option>
                        </select>
            ...
            $.get(url, data, function(result, status, xhr) {
                if (result.status) {
                    ...
                    $.each(result.plan, function(index, value) {
                        ...
                        var style = '';
                        if (value.key.includes("ROLLER")) {
                            style = "color:#3c3c3c; background-color:#fefefe;";
                        } else {
                            style = "color:#f2e127; background-color:#333;";
                        }

                        model += "<th style='" + style + "'>" + value.model +
