                        ...
                        Highcharts.chart('container8', {
                            ...
                            yAxis: {
                                ...
                                tickPositioner: function() {
                                    if (this.dataMax > 0) {
                                        var maxDeviation = Math.ceil(Math.max(Math.abs(this.dataMax),
                                            Math.abs(this.dataMin)));
                                    } else {
                                        var maxDeviation = 100;
                                    }
                                    var halfMaxDeviation = Math.ceil(maxDeviation / 2);

                                    return [-maxDeviation, -halfMaxDeviation, 0, halfMaxDeviation,
                                        maxDeviation
                                    ];
                                }
                            },
            ...
            $.get('{{ url('fetch/dp_fg_accuracy') }}', function(result, status, xhr) {
                ...
                if (xhr.status == 200) {
                    if (result.status) {
                        ...
                        $('#last_update').html('<b><span style="font-size: 14px;">Last Updated: ' +
                            getActualFullDate() + '</span></b>');
                        ...
                        window.chart = Highcharts.stockChart('container1', {
                            ...
                            yAxis: {
                                tickPositioner: function() {
                                    ...
                                    var maxDeviation = Math.ceil(Math.max(Math.abs(this.dataMax), Math
                                        .abs(this.dataMin)));
                                    if (maxDeviation <= 0) {
                                        maxDeviation = 1;
                                    }
