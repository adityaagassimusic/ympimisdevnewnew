                            ...
                            <div class="col-xs-12" style="margin-top: 3%;">
                                ...
                                <select class="form-control select2" multiple="multiple" id='shipment_hpl'
                                    ...
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->hpl }}">{{ $location->category }} -
                                            {{ $location->hpl }}</option>
                                    @endforeach
                                </select>
                            </div>
...
@section('scripts')
    ...
    <script>
        ...
        function fillTableShipment() {
            ...
            $.get('{{ url('fetch/generate_shipment_schedule') }}', data, function(result, status, xhr) {
                ...
                tableHead += '<th style="vertical-align: middle; text-align: center;">SALES ORDER</th>';
                    ...
                    for (var j = 0; j < result.dates.length; j++) {
                        ...
                        for (var k = 0; k < result.shipments.length; k++) {
                            ...
                            if ((result.shipments[k].destination_code == result.sales_orders[i].destination_code) &&
                                (result.shipments[k].sales_order == result.sales_orders[i].sales_order) &&
