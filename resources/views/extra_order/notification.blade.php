        ...
        <div class="row">
            <div class="error" style="text-align: center;">
                ...
                <h2>
                    {{-- Sudah di Reject --}}
                    @if ($code == 0)
                        <p class="eo_number" onclick="detailExtraOrder('{{ $approval->eo_number }}')">
                            {{ $approval->eo_number }}</p>
                        ...
                        @endif
                        <p class="status"><i style="color : grey;" class="fa fa-info-circle"></i>&nbsp;&nbsp;ALREADY
                            REJECTED!</p>
                    ...
                    @elseif($code == 1)
                        ...
                        @endif
                        <p class="status"><i style="color : #0bb13d;"
                                class="fa fa-check-square-o"></i>&nbsp;&nbsp;&nbsp;{{ $approval->status }}!</p>
                    ...
                    @elseif($code == 2)
                        ...
                        @endif
                        <p class="status"><i style="color : #68cae6" class="fa fa-info-circle"></i>&nbsp;&nbsp;ALREADY
                            APPROVED!</p>
                    ...
                    @elseif($code == 5)
                        ...
                        <p class="status"><i style="color : #c51c42"
                                class="fa fa-exclamation-triangle"></i>&nbsp;&nbsp;REJECTED!</p>
                    ...
                    @elseif($code == 103)
                        ...
                        <p class="status"><i style="color : #0bb13d" class="fa fa-check-square"></i>&nbsp;&nbsp;REJECT PO
                            SUCCESSFULLY!</p>
                    ...
                    @elseif($code == 201)
                        ...
                        <p class="status"><i style="color : #c51c42" class="fa fa-remove"></i>&nbsp;&nbsp;FAILED!</p>
                    @elseif($code == 202)
                        {{-- Delete PO link invalid --}}
                        <p class="message">
                            Invalid link<br>
                            <span class="text-purple">無効なリンク</span>
                        </p>
                        <p class="status"><i style="color : #c51c42" class="fa fa-remove"></i>&nbsp;&nbsp;FAILED!</p>
                    @elseif($code == 203)
                        {{-- Delete PO reject sukses --}}
                        <p class="message">
                            Requests for Deletion Sending Application<br>Successfully Rejected!
                        </p>
                        <p class="status"><i style="color : #0bb13d" class="fa fa-check-square"></i>&nbsp;&nbsp;SUCCESS!
                        </p>
                    @elseif($code == 204)
                        {{-- Delete PO approve sukses --}}
                        <p class="message">
                            Requests for Deletion Sending Application<br>Successfully Approved!
                        </p>
                        <p class="status"><i style="color : #0bb13d" class="fa fa-check-square"></i>&nbsp;&nbsp;SUCCESS!
                        </p>
                    @elseif($code == 205)
                        {{-- Error --}}
                        <p class="status"><i style="color : #c51c42" class="fa fa-remove"></i>&nbsp;&nbsp;ERROR!</p>
                        <p class="message">{{ $message }}</p>
                    @elseif($code == 206)
                        {{-- Delete PO reject sukses --}}
                        <p class="message">
                            Sorry, sending application can't delete,<br>Because shipment doc. already prepared by exim staff
                        </p>
                        <p class="status"><i style="color : #c51c42" class="fa fa-remove"></i>&nbsp;&nbsp;FAILED!</p>
                        </p>
                    @endif
                ...
                @if ($code < 100)
                    ...
                    <center>
                        ...
                        <a class="btn btn-xs btn-primary"
                            style="background-color: #25b2fd; text-decoration: none; color: black;"
                            href="{{ url('index/extra_order/approval_monitoring?submit_from=&submit_to=&approver_id=') . strtoupper(Auth::user()->username) }}">&nbsp;&nbsp;
                            EOC Approval Monitoring&nbsp;&nbsp;
                        </a>
                    </center>
                @endif
