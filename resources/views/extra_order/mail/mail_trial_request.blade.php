...
<body>
    <div>
        ...
        <br>
        <center>
            There is a new item request without GMC From EO with number <b>{{ $data['eo_number'] }}</b><br>
            Please process this request as soon as possible.<br>
        </center>
        ...
        <center>
            ...
            <a href="{{ url('index/sakurentsu/list_material') }}">&#10148; Process BOM & Standart Time</a>
        </center>
    </div>
</body>
