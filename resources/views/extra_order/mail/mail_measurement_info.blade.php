...
<body>
    <div>
        <center>
            ...
            <p class="msg">New sending application already measured by warehouse
                <br>Please prepare the shipment document as soon as possible!
            </p>
        </center>
        <br>
            ...
            <table style="border:1px solid black; border-collapse: collapse; width: 100%;">
                <thead>
                    <tr>
                        ...
                        <th style="border:1px solid black; background-color: #aee571;">Price</th>
                        <th style="border:1px solid black; background-color: #aee571;">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    for ($i = 0; $i < count($data['send_app_detail']); $i++) {
                        print_r('<tr>');
                        print_r('<td style="border: 1px solid black; width: 1%; text-align: center;">' . $data['send_app_detail'][$i]['sequence'] . '</td>');
        ...
        <br>
        <center>
            <a href="{{ url('index/extra_order/sending_application') }}">&#10148; Click here to check the send app
            </a>
        </center>
        <br>
        <br>
